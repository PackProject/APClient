 ...
 * @details This seems to be a member of of a parent "player" class, but this
 * holds all relevant information about a boxer, from health/state to even the
 * time they will get up when knocked down.
 * @customname
 */
class RPBoxBoxer {
public:
