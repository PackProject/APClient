 ...
 * @details The combo system rewards alternating hands when punching, and
 * increases punch strength over time. If the player either waits too long or
 * does not alternate hands, the combo will reset.
 * @customname
 */
