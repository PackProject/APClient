...
extern void RFCOMM_DlcEstablishRsp(tRFC_MCB* p_mcb, UINT8 dlci, UINT16 mtu,
                                   UINT16 result);
...
extern void RFCOMM_ParNegRsp(tRFC_MCB* p_mcb, UINT8 dlci, UINT16 mtu, UINT8 cl,
                             UINT8 k);
...
extern void RFCOMM_LineStatusReq(tRFC_MCB* p_mcb, UINT8 dlci,
                                 UINT8 line_status);
/*
...
#define RFC_PORT_T1_TIMEOUT                                                    \
    60 /* seconds to wait for reply with Poll bit other than MX */
...
typedef struct {
    ...
    tRFC_MCB*
        p_rfc_lcid_mcb[MAX_L2CAP_CHANNELS]; /* MCB based on the L2CAP's lcid */
...
extern void rfc_process_pn(tRFC_MCB* p_rfc_mcb, BOOLEAN is_command,
                           MX_FRAME* p_frame);
extern void rfc_process_msc(tRFC_MCB* p_rfc_mcb, BOOLEAN is_command,
                            MX_FRAME* p_frame);
extern void rfc_process_rpn(tRFC_MCB* p_rfc_mcb, BOOLEAN is_command,
                            BOOLEAN is_request, MX_FRAME* p_frame);
extern void rfc_process_rls(tRFC_MCB* p_rfc_mcb, BOOLEAN is_command,
                            MX_FRAME* p_frame);
...
extern void rfc_sec_check_complete(BD_ADDR bd_addr, void* p_ref_data,
                                   UINT8 res);
...
extern void rfc_send_pn(tRFC_MCB* p_mcb, UINT8 dlci, BOOLEAN is_command,
                        UINT16 mtu, UINT8 cl, UINT8 k);
extern void rfc_send_test(tRFC_MCB* p_rfc_mcb, BOOLEAN is_command,
                          BT_HDR* p_buf);
extern void rfc_send_msc(tRFC_MCB* p_mcb, UINT8 dlci, BOOLEAN is_command,
                         tPORT_CTRL* p_pars);
extern void rfc_send_rls(tRFC_MCB* p_mcb, UINT8 dlci, BOOLEAN is_command,
                         UINT8 status);
...
extern UINT8 rfc_parse_data(tRFC_MCB* p_rfc_mcb, MX_FRAME* p_frame,
                            BT_HDR* p_buf);
...
extern void PORT_DlcEstablishCnf(tRFC_MCB* p_mcb, UINT8 dlci, UINT16 mtu,
                                 UINT16 result);
...
extern void PORT_ParNegInd(tRFC_MCB* p_mcb, UINT8 dlci, UINT16 mtu, UINT8 cl,
                           UINT8 k);
extern void PORT_ParNegCnf(tRFC_MCB* p_mcb, UINT8 dlci, UINT16 mtu, UINT8 cl,
                           UINT8 k);
...
extern void PORT_PortNegInd(tRFC_MCB* p_mcb, UINT8 dlci, tPORT_STATE* p_pars,
                            UINT16 param_mask);
extern void PORT_PortNegCnf(tRFC_MCB* p_mcb, UINT8 dlci, tPORT_STATE* p_pars,
                            UINT16 result);
