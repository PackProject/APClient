...
#define HCI_SHORT_RANGE_MODE                                                   \
    (0x006B | HCI_GRP_HOST_CONT_BASEBAND_CMDS) /* 802.11 only */
...
#define HCI_VALID_SCO_PKT_TYPE(t)                                              \
    (((((t) & ~(HCI_PKT_TYPES_MASK_HV1 | HCI_PKT_TYPES_MASK_HV2 |              \
...
#define HCI_VALID_ESCO_PKT_TYPE(t)                                             \
    (((((t) & ~(HCI_ESCO_PKT_TYPES_MASK_EV3 | HCI_ESCO_PKT_TYPES_MASK_EV4 |    \
...
#define HCI_VALID_ESCO_SCOPKT_TYPE(t)                                          \
    (((((t) & ~(HCI_ESCO_PKT_TYPES_MASK_HV1 | HCI_ESCO_PKT_TYPES_MASK_HV2 |    \
...
#define HCI_DO_AUTO_ACCEPT_CONNECT_RS                                          \
    3 /* role switch enabled (1.1 errata 1115) */
...
#define HCI_LMP_ALIAS_AUTH_SUPPORTED(x)                                        \
    ((x)[HCI_FEATURE_ALIAS_AUTH_OFF] & HCI_FEATURE_ALIAS_AUTH_MASK)

#define HCI_FEATURE_ANON_MODE_MASK 0x40
#define HCI_FEATURE_ANON_MODE_OFF 4
#define HCI_LMP_ANON_MODE_SUPPORTED(x)                                         \
    ((x)[HCI_FEATURE_ANON_MODE_OFF] & HCI_FEATURE_ANON_MODE_MASK)
...
#else
#define HCI_NON_FLUSHABLE_PB_SUPPORTED(x)                                      \
    ((x)[HCI_FEATURE_NON_FLUSHABLE_PB_OFF] & HCI_FEATURE_NON_FLUSHABLE_PB_MASK)
#endif
// btla-specific --
...
#define HCI_CREATE_CONN_SUPPORTED(x)                                           \
    ((x)[HCI_SUPP_COMMANDS_CREATE_CONN_OFF] &                                  \
     HCI_SUPP_COMMANDS_CREATE_CONN_MASK)
...
#define HCI_SWITCH_ROLE_SUPPORTED(x)                                           \
    ((x)[HCI_SUPP_COMMANDS_SWITCH_ROLE_OFF] &                                  \
     HCI_SUPP_COMMANDS_SWITCH_ROLE_MASK)
...
#define HCI_IO_CAPABILITY_RESPONSE_SUPPORTED(x)                                \
    ((x)[HCI_SUPP_COMMANDS_IO_CAPABILITY_RESPONSE_OFF] &                       \
     HCI_SUPP_COMMANDS_IO_CAPABILITY_RESPONSE_MASK)
