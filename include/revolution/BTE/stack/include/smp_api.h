...
#define SMP_UNKNOWN_IO_CAP                                                     \
    0x0B /* unknown IO capability, unable to decide associatino model */
...
#define SMP_AUTH_NB_ENC_ONLY                                                   \
    0x00 //(SMP_AUTH_MASK | BTM_AUTH_SP_NO)   /* no MITM, No Bonding, Encryptino
         // only */
#define SMP_AUTH_NB_IOCAP                                                      \
    (SMP_AUTH_NO_BOND | SMP_AUTH_YN_BIT) /* MITM, No Bonding, Use IO           \
          Capability to detrermine authenticaion procedure */
#define SMP_AUTH_GB_ENC_ONLY                                                   \
    (SMP_AUTH_GEN_BOND) /* no MITM, General Bonding, Encryptino only */
#define SMP_AUTH_GB_IOCAP                                                      \
    (SMP_AUTH_GEN_BOND | SMP_AUTH_YN_BIT) /* MITM, General Bonding, Use IO     \
           Capability to detrermine authenticaion procedure   */
...
**
*******************************************************************************/
SMP_API extern void SMP_PasskeyReply(BD_ADDR bd_addr, UINT8 res,
                                     UINT32 passkey);
...
**
*******************************************************************************/
SMP_API extern void SMP_OobDataReply(BD_ADDR bd_addr, tSMP_STATUS res,
...
*******************************************************************************/
SMP_API extern BOOLEAN SMP_Encrypt(UINT8* key, UINT8 key_len, UINT8* plain_text,
