...
#define AVDTC_GETCAP_IND_EVT                                                   \
    (1 + AVDTC_EVT_BEGIN) /* Get capabilities indication */
#define AVDTC_SETCONFIG_CFM_EVT                                                \
    (2 + AVDTC_EVT_BEGIN) /* Set configuration confirm */
#define AVDTC_GETCONFIG_IND_EVT                                                \
    (3 + AVDTC_EVT_BEGIN) /* Get configuration indication */
#define AVDTC_GETCONFIG_CFM_EVT                                                \
    (4 + AVDTC_EVT_BEGIN)                        /* Get configuration confirm */
...
typedef void tAVDTC_CTRL_CBACK(UINT8 handle, BD_ADDR bd_addr, UINT8 event,
                               tAVDTC_CTRL* p_data);
...
**
*******************************************************************************/
AVDT_API extern void AVDTC_GetCapRsp(BD_ADDR bd_addr, UINT8 label,
                                     tAVDT_CFG* p_cap);
...
**
*******************************************************************************/
AVDT_API extern void AVDTC_GetAllCapRsp(BD_ADDR bd_addr, UINT8 label,
                                        tAVDT_CFG* p_cap);
...
**
*******************************************************************************/
AVDT_API extern void AVDTC_GetConfigRsp(UINT8 handle, UINT8 label,
                                        tAVDT_CFG* p_cfg);
...
**
*******************************************************************************/
AVDT_API extern void AVDTC_StartRsp(UINT8* p_handles, UINT8 num_handles,
                                    UINT8 label);
...
**
*******************************************************************************/
AVDT_API extern void AVDTC_SuspendRsp(UINT8* p_handles, UINT8 num_handles,
                                      UINT8 label);
...
**
*******************************************************************************/
AVDT_API extern void AVDTC_Rej(UINT8 handle, BD_ADDR bd_addr, UINT8 cmd,
                               UINT8 label, UINT8 err_code, UINT8 err_param);
