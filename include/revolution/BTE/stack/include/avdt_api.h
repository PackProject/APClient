...
#define AVDT_RTCP_PT_SDES                                                      \
    202 /* the packet type - SDES (Source Description)                         \
         */
...
#define AVDT_ERR_INVALID_CAP                                                   \
    0x1A /* Reconfigure attempted invalid capabilities */
...
#define AVDT_ERR_ROHC_FMT                                                      \
    0x26 /* Header compression service capability not correct */
#define AVDT_ERR_CP_FMT                                                        \
    0x27 /* Content protection service capability not correct */
#define AVDT_ERR_MUX_FMT                                                       \
    0x28                        /* Multiplexing service capability not correct \
                                 */
#define AVDT_ERR_UNSUP_CFG 0x29 /* Configuration not supported */
#define AVDT_ERR_BAD_STATE                                                     \
    0x31                          /* Message cannot be processed in this state \
                                   */
...
typedef struct {
    ...
    UINT8 mux_mask;       /* Multiplexing capabilities. AVDT_MUX_XXX bits can be
...
** This callback is called when AVDTP has a media packet ready for the
*application.
** This function is required for SNK endpoints and not applicable for SRC
*endpoints.
*/
typedef void(tAVDT_MEDIA_CBACK)(UINT8 handle, UINT8* p_payload,
                                UINT32 payload_len, UINT32 time_stamp,
                                UINT16 seq_num, UINT8 m_pt, UINT8 marker);
#endif
...
typedef UINT16(tAVDT_GETCAP_REQ)(BD_ADDR bd_addr, UINT8 seid, tAVDT_CFG* p_cfg,
...
#if AVDT_MULTIPLEXING == TRUE
    tAVDT_MEDIA_CBACK* p_media_cback; /* Media callback function. It will be
                                         called only if p_data_cback is NULL */
#endif
#if AVDT_REPORTING == TRUE
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_DiscoverReq(BD_ADDR bd_addr,
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_GetCapReq(BD_ADDR bd_addr, UINT8 seid,
                                      tAVDT_CFG* p_cfg,
                                      tAVDT_CTRL_CBACK* p_cback);
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_GetAllCapReq(BD_ADDR bd_addr, UINT8 seid,
                                         tAVDT_CFG* p_cfg,
                                         tAVDT_CTRL_CBACK* p_cback);
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_ConfigRsp(UINT8 handle, UINT8 label,
                                      UINT8 error_code, UINT8 category);
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_ReconfigRsp(UINT8 handle, UINT8 label,
                                        UINT8 error_code, UINT8 category);
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_SecurityReq(UINT8 handle, UINT8* p_data,
                                        UINT16 len);
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_SecurityRsp(UINT8 handle, UINT8 label,
                                        UINT8 error_code, UINT8* p_data,
                                        UINT16 len);
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_WriteReq(UINT8 handle, BT_HDR* p_pkt,
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_DisconnectReq(BD_ADDR bd_addr,
                                          tAVDT_CTRL_CBACK* p_cback);
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_WriteDataReq(UINT8 handle, UINT8* p_data,
                                         UINT32 data_len, UINT32 time_stamp,
                                         UINT8 m_pt, UINT8 marker);

/*******************************************************************************
**
** Function         AVDT_SetMediaBuf
**
** Description      Assigns buffer for media packets or forbids using of
*assigned
**                  buffer if argument p_buf is NULL. This function can only
**                  be called if the stream is a SNK.
**
**                  AVDTP uses this buffer to reassemble fragmented media
*packets.
...
**                  different buffer for next media packet or can leave the
*current
...
**
*******************************************************************************/
AVDT_API extern UINT16 AVDT_SetMediaBuf(UINT8 handle, UINT8* p_buf,
                                        UINT32 buf_len);
