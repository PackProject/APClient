...
** If the app returns none zero, the connection or inquiry result will be
*dropped.
*/
...
#define BTM_SSP_INQUIRY_ACTIVE                                                 \
    0x4 /* SSP is active, so inquiry is disallowed (work around for FW bug) */
...
#define BTM_FILTER_COND_DEVICE_CLASS                                           \
    HCI_FILTER_COND_DEVICE_CLASS /* Filter on device class */
...
#define BTM_EIR_COMPLETE_16BITS_UUID_TYPE                                      \
    HCI_EIR_COMPLETE_16BITS_UUID_TYPE                               /* 0x03 */
#define BTM_EIR_MORE_32BITS_UUID_TYPE HCI_EIR_MORE_32BITS_UUID_TYPE /* 0x04 */
#define BTM_EIR_COMPLETE_32BITS_UUID_TYPE                                      \
    HCI_EIR_COMPLETE_32BITS_UUID_TYPE /* 0x05 */
#define BTM_EIR_MORE_128BITS_UUID_TYPE                                         \
    HCI_EIR_MORE_128BITS_UUID_TYPE /* 0x06                                     \
                                    */
#define BTM_EIR_COMPLETE_128BITS_UUID_TYPE                                     \
    HCI_EIR_COMPLETE_128BITS_UUID_TYPE /* 0x07 */
#define BTM_EIR_SHORTENED_LOCAL_NAME_TYPE                                      \
    HCI_EIR_SHORTENED_LOCAL_NAME_TYPE /* 0x08 */
#define BTM_EIR_COMPLETE_LOCAL_NAME_TYPE                                       \
    HCI_EIR_COMPLETE_LOCAL_NAME_TYPE                            /* 0x09 */
#define BTM_EIR_TX_POWER_LEVEL_TYPE HCI_EIR_TX_POWER_LEVEL_TYPE /* 0x0A */
#define BTM_EIR_MANUFACTURER_SPECIFIC_TYPE                                     \
    HCI_EIR_MANUFACTURER_SPECIFIC_TYPE /* 0xFF */
...
#define BTM_OOB_MANDATORY_SIZE                                                 \
    8 /* include 2 bytes length & 6 bytes bd_addr                              \
       */
...
#define BTM_EIR_SERVICE_ARRAY_SIZE                                             \
    (((UINT32)BTM_EIR_MAX_SERVICES / BTM_EIR_ARRAY_BITS) +                     \
...
#define BTM_EIR_SET_SERVICE(p, service)                                        \
    (((UINT32*)(p))[(((UINT32)(service)) / BTM_EIR_ARRAY_BITS)] |=             \
...
#define BTM_EIR_HAS_SERVICE(p, service)                                        \
    ((((UINT32*)(p))[(((UINT32)(service)) / BTM_EIR_ARRAY_BITS)] &             \
      ((UINT32)1 << (((UINT32)(service)) % BTM_EIR_ARRAY_BITS))) >>            \
     (((UINT32)(service)) % BTM_EIR_ARRAY_BITS))
...
typedef struct /* contains the parameters passed to the inquiry functions */
{
    ...
    BOOLEAN report_dup; /* report duplicated inquiry response with higher RSSI
                           value */
...
typedef struct {
    ...
    BOOLEAN
    appl_knows_rem_name; /* set by application if it knows the remote name
                            of the peer device. This is later used by
                            application to determine if remote name request
                            is required to be done. Having the flag here
                            avoid duplicate store of inquiry results */
...
/* Structure returned with link policy information (in tBTM_CMPL_CB callback
 *function)
...
/* Structure returned with Change Link Key information (in tBTM_CMPL_CB callback
 *function)
...
typedef struct {
    UINT8 hci_status; /* HCI status returned with the event */
    BD_ADDR
    remote_bd_addr; /* Remote BD addr involved with the change link key */
...
#define BTM_VOICE_SETTING_CVSD                                                 \
    ((UINT16)(HCI_INP_CODING_LINEAR | HCI_INP_DATA_FMT_2S_COMPLEMENT |         \
...
#define BTM_SEC_IN_AUTHENTICATE                                                \
    0x0002                        /* Inbound call requires authentication */
#define BTM_SEC_IN_ENCRYPT 0x0004 /* Inbound call requires encryption */
#define BTM_SEC_OUT_AUTHORIZE                                                  \
    0x0008 /* Outbound call requires authorization                             \
            */
#define BTM_SEC_OUT_AUTHENTICATE                                               \
    0x0010                         /* Outbound call requires authentication */
...
#define BTM_SEC_FORCE_MASTER                                                   \
    0x0100 /* Need to switch connection to be master                           \
            */
#define BTM_SEC_ATTEMPT_MASTER                                                 \
    0x0200 /* Try to switch connection to be master */
#define BTM_SEC_FORCE_SLAVE                                                    \
    0x0400 /* Need to switch connection to be master                           \
            */
#define BTM_SEC_ATTEMPT_SLAVE                                                  \
    0x0800                      /* Try to switch connection to be slave        \
                                 */
...
/************************************************************************************************
** Security Services MACROS handle array of UINT32 bits for more than 32 trusted
*services
*************************************************************************************************/
...
#define BTM_SEC_TRUST_HID_NOSEC_CTRL                                           \
    (1 << (BTM_SEC_SERVICE_HID_NOSEC_CTRL - 32))
...
#define BTM_AUTH_SP_NO                                                         \
    0 /* MITM Protection Not Required - Single Profile/non-bonding             \
      Numeric comparison with automatic accept allowed */
#define BTM_AUTH_SP_YES                                                        \
    1 /* MITM Protection Required - Single Profile/non-bonding                 \
      Use IO Capabilities to determine authentication procedure */
#define BTM_AUTH_AP_NO                                                         \
    2 /* MITM Protection Not Required - All Profiles/dedicated bonding         \
      Numeric comparison with automatic accept allowed */
#define BTM_AUTH_AP_YES                                                        \
    3 /* MITM Protection Required - All Profiles/dedicated bonding             \
      Use IO Capabilities to determine authentication procedure */
#define BTM_AUTH_SPGB_NO                                                       \
    4 /* MITM Protection Not Required - Single Profiles/general bonding        \
      Numeric comparison with automatic accept allowed */
#define BTM_AUTH_SPGB_YES                                                      \
    5 /* MITM Protection Required - Single Profiles/general bonding            \
      Use IO Capabilities to determine authentication procedure */
#define BTM_AUTH_DD_BOND                                                       \
    2 /* this bit is ORed to the BTM_AUTH_SP_* when IO exchange for dedicated  \
         bonding */
...
typedef struct {
    ...
    UINT32 num_val; /* the numeric value for comparison. If just_works, do not
...
#define BTM_LE_KEY_PENC                                                        \
    SMP_SEC_KEY_TYPE_ENC /* encryption information of peer device */
#define BTM_LE_KEY_PID                                                         \
    SMP_SEC_KEY_TYPE_ID /* identity key of the peer device                     \
                         */
#define BTM_LE_KEY_PCSRK SMP_SEC_KEY_TYPE_CSRK /* peer SRK */
#define BTM_LE_KEY_LENC                                                        \
    (SMP_SEC_KEY_TYPE_ENC << 3) /* master role security information:div */
#define BTM_LE_KEY_LID (SMP_SEC_KEY_TYPE_ID << 3) /* master device ID key */
#define BTM_LE_KEY_LCSRK                                                       \
    (SMP_SEC_KEY_TYPE_CSRK << 3) /* local CSRK has been deliver to peer */
...
typedef struct {
    ...
    tBTM_LE_AUTH_REQ auth_req;  /* Authentication request (for local device)
                                   contain bonding and MITM info */
...
** events occur.
*/
typedef UINT8(tBTM_LE_CALLBACK)(tBTM_LE_EVT event, BD_ADDR bda,
...
#define BTM_PM_DEREG                                                           \
    4 /* The module does not want to involve with PM anymore                   \
       */
...
/* These macros are defined to check the Broadcom features supported in
 * controller (the return value for BTM_ReadBrcmFeatures() */
/* multi-av */
#define BTM_FEATURE_MULTI_AV_MASK 0x01
#define BTM_FEATURE_MULTI_AV_OFF 0
#define BTM_VSC_MULTI_AV_SUPPORTED(x)                                          \
    ((x)[BTM_FEATURE_MULTI_AV_OFF] & BTM_FEATURE_MULTI_AV_MASK)

/* WBS SBC codec */
#define BTM_FEATURE_WBS_SBC_MASK 0x02
#define BTM_FEATURE_WBS_SBC_OFF 0
#define BTM_VSC_WBS_SBC_SUPPORTED(x)                                           \
    ((x)[BTM_FEATURE_WBS_SBC_OFF] & BTM_FEATURE_WBS_SBC_MASK)

/* Advanced Audio LC-PLC */
#define BTM_FEATURE_AUDIO_LC_PLC_MASK 0x04
#define BTM_FEATURE_AUDIO_LC_PLC_OFF 0
#define BTM_VSC_AUDIO_LC_PLC_SUPPORTED(x)                                      \
    ((x)[BTM_FEATURE_AUDIO_LC_PLC_OFF] & BTM_FEATURE_AUDIO_LC_PLC_MASK)

/* Light stack for audio routing in Controller */
#define BTM_FEATURE_LIGHT_STACK_MASK 0x08
#define BTM_FEATURE_LIGHT_STACK_OFF 0
#define BTM_VSC_LIGHT_STACK_SUPPORTED(x)                                       \
    ((x)[BTM_FEATURE_LIGHT_STACK_OFF] & BTM_FEATURE_LIGHT_STACK_MASK)

/* NFC support */
#define BTM_FEATURE_NFC_MASK (HCI_BRCM_FEATURE_NFC_MASK) /* 0x10 */
#define BTM_FEATURE_NFC_OFF (HCI_BRCM_FEATURE_NFC_OFF)   /* 0    */
#define BTM_VSC_NFC_SUPPORTED(x)                                               \
    ((x)[BTM_FEATURE_NFC_OFF] & BTM_FEATURE_NFC_MASK)
...
#define BTM_SW_TO_BB                                                           \
    1 /* Switch back to baseband stack (from either MM or BTC host) */
#define BTM_SW_RESYNC 2
#define BTM_SW_BB_TO_BTC                                                       \
    3 /* Switch from baseband stack to Bluetooth Controller Host stack */
...
/* Synchronization info from BTA/application that will be sent when calling BTE
...
*/
typedef void (*tBTM_SYNC_STACK_CBACK)(tBTM_SYNC_STACK_EVT event,
                                      tBTM_SYNC_STATUS status);

/* Sync complete callback function. Called by bte layers after synchronization
 *is complete
...
typedef BOOLEAN(tBTM_MIP_QUERY_CB)(BD_ADDR dev_addr, UINT8* p_mode,
                                   LINK_KEY link_key);
...
**
** Description      This function is called to set the channel assessment mode
*on or off
**
** Returns          status
**
...
BTM_SetAfhChannelAssessment(BOOLEAN enable_or_disable);

/*******************************************************************************
**
** Function         BTM_DeviceReset
**
** Description      This function is called to reset the controller.The Callback
*function
...
**
** Description      This function is called to read the Broadcom specific
*features
**
...
**
*******************************************************************************/
BTM_API extern tBTM_DEV_STATUS_CB*
BTM_RegisterForDeviceStatusNotif(tBTM_DEV_STATUS_CB* p_cb);
...
**                  if is_register=FALSE, then the function will be
*deregistered.
**
...
**                      sequence.  (BTM_APP_DEV_INIT is defined with a
*function).
**
** Returns          void
**
...
/*****************************************************************************
**  DEVICE DISCOVERY FUNCTIONS - Inquiry, Remote Name, Discovery, Class of
*Device
*****************************************************************************/
...
*******************************************************************************/
BTM_API extern tBTM_STATUS
BTM_SetDiscoverability(UINT16 inq_mode, UINT16 window, UINT16 interval);
...
*******************************************************************************/
BTM_API extern tBTM_STATUS
BTM_SetPeriodicInquiryMode(tBTM_INQ_PARMS* p_inqparms, UINT16 max_delay,
...
*called
**                                upon receipt of an inquiry result. If this
*field is
...
**
** Description      This function is called to set the device into or out of
**                  connectable mode. Discoverable mode means page scans
*enabled.
**
** Returns          BTM_SUCCESS if successful
**                  BTM_ILLEGAL_VALUE if a bad parameter is detected
...
*******************************************************************************/
BTM_API extern tBTM_STATUS
BTM_SetConnectability(UINT16 page_mode, UINT16 window, UINT16 interval);
...
**
*******************************************************************************/
BTM_API extern UINT16 BTM_ReadConnectability(UINT16* p_window,
                                             UINT16* p_interval);
...
*first
**                  used entrysince the LAST inquiry. This is used in
*conjunction
**                  with BTM_InqNext by applications as a way to walk through
*the
...
** Description      This function looks through the inquiry database for the
*next
**                  used entrysince the LAST inquiry. If the input parameter is
*NULL,
...
** Description      This function looks through the inquiry database for the
*first
**                  used entry, and returns that. This is used in conjunction
*with
...
** Description      This function looks through the inquiry database for the
*next
**                  used entry, and returns that.  If the input parameter is
*NULL,
**                  the first entry is returned.
**
** Returns          pointer to next in-use entry, or NULL if no more found.
...
**
** Returns          This function returns the number of entries in the inquiry
*database.
**
*******************************************************************************/
...
*******************************************************************************/
BTM_API extern tBTM_STATUS
BTM_InquiryRegisterForChanges(tBTM_INQ_DB_CHANGE_CB* p_cb);
...
**
** Description      This command is used to write the inquiry transmit power
*level
**                  used to transmit the inquiry (ID) data packets. The
*Controller
**                  should use the supported TX power level closest to the
*Tx_Power
**                  parameter.
**
** Returns          BTM_SUCCESS if successful
...
**
*******************************************************************************/
BTM_API extern void BTM_SetDiscoveryParams(UINT16 num_uuid,
...
*******************************************************************************/
BTM_API extern tBTM_STATUS
BTM_SetHoldMode(BD_ADDR remote_bda, UINT16 min_interval, UINT16 max_interval);
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetSniffMode(BD_ADDR remote_bda,
                                            UINT16 min_period,
...
**
** Description      This function is called to put a connection out of park
*mode.
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetPacketTypes(BD_ADDR remote_bda,
                                              UINT16 pkt_types);
...
**                  ACL connection,
**
** Returns          packet types supported for the connection, or 0 if no BD
*address
**
*******************************************************************************/
...
BTM_API extern tBTM_STATUS BTM_SwitchRole(BD_ADDR remote_bd_addr,
                                          UINT8 new_role, tBTM_CMPL_CB* p_cb);
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ReadLinkQuality(BD_ADDR remote_bda,
                                               tBTM_CMPL_CB* p_cb);
...
*******************************************************************************/
BTM_API extern tBTM_STATUS
BTM_AclRegisterForChanges(tBTM_ACL_DB_CHANGE_CB* p_cb);
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetScoPacketTypes(UINT16 sco_inx,
                                                 UINT16 pkt_types);
...
*******************************************************************************/
BTM_API extern tBTM_STATUS
BTM_ChangeEScoLinkParms(UINT16 sco_inx, tBTM_CHG_ESCO_PARAMS* p_parms);
...
**
*******************************************************************************/
BTM_API extern BOOLEAN BTM_GetSecurityFlags(BD_ADDR bd_addr,
                                            UINT8* p_sec_flags);
...
**
*******************************************************************************/
BTM_API extern BOOLEAN BTM_SetUCDSecurityLevel(BOOLEAN is_originator,
...
**                  Typically used only by devices with limited RAM so that it
*can
...
BTM_API extern BOOLEAN BTM_SecAddDevice(BD_ADDR bd_addr, DEV_CLASS dev_class,
                                        ...
                                        UINT32 trusted_mask[],
                                        LINK_KEY link_key, UINT8 key_type,
                                        tBTM_IO_CAP io_cap);
...
**
** Description      This function is called to register for the master key
*complete
**                  status event.
**
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SetEncryption(BD_ADDR bd_addr,
...
*success
**                  bd_addr       - Address of the peer device
**                  passkey       - numeric value in the range of 0 -
*999999(0xF423F).
**
*******************************************************************************/
...
**
*******************************************************************************/
BTM_API extern void BTM_SendKeypressNotif(BD_ADDR bd_addr,
...
**
*******************************************************************************/
BTM_API extern UINT16 BTM_BuildOobData(UINT8* p_data, UINT16 max_len,
                                       BT_OCTET16 c, BT_OCTET16 r,
                                       UINT8 name_len);
...
**
*******************************************************************************/
BTM_API extern UINT8* BTM_ReadOobData(UINT8* p_data, UINT8 eir_tag,
                                      UINT8* p_len);
...
**
** Description      This function is called to check if power manager is
*included.
**                  in the BTE version.
**
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_ReadStoredLinkKey(BD_ADDR bd_addr,
                                                 tBTM_CMPL_CB* p_cb);
...
**                  device addresses to the NVRAM storage attached to the
*Bluetooth
**                  controller.
**
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_DeleteStoredLinkKey(BD_ADDR bd_addr,
                                                   tBTM_CMPL_CB* p_cb);
...
**
*******************************************************************************/
BTM_API extern UINT8* BTM_CheckEirData(UINT8* p_eir, UINT8 type,
                                       UINT8* p_length);
...
BTM_API extern UINT8 BTM_GetEirUuidList(UINT8* p_eir, UINT8 uuid_size,
                                        UINT8* p_num_uuid, UINT8* p_uuid_list,
                                        UINT8 max_num_uuid);
...
**                  (e.g. BTA or application) have completed synchronizing
*bta/app
...
**
**                  p_btm_sync_info: information from bta/app that will be
*needed
...
**
*******************************************************************************/
BTM_API extern void BTM_SyncBtaRsp(tBTM_STATUS status,
...
**                  main stack (running on phone baseband) to embedded light
*stack
...
**
**                  buffer: Pointer to the buffer to be passed in the IPC
*message
**
** Returns          void
**
...
**
** Description      registers the RT(Audio Routing) provided handler for IPC
*events
**
**
** Returns          void
...
*******************************************************************************/
BTM_API extern void
BTM_N2BtAcquire(BD_ADDR bd_addr, UINT16 timeout, UINT8 freq, UINT8 src_addrlen,
                UINT8 sensor_flags, UINT8 sensor_type,
                UINT8 sensor_clk_accuracy, UINT16 add_rx_window,
                UINT16 init_crc, UINT32 ac_low, UINT32 ac_high, UINT16 pkt_hdr,
                UINT16 list_dur, UINT16 list_int, UINT8 oor_missed_pkts,
                tBTM_VSC_CMPL_CB* p_cb, tBTM_N2BT_DATA_CB* p_data_cback);
...
**                               the control block will be used; otherwise
*update
**                               control block value.
...
**                  BTM_CMD_STARTED :Command sent. Waiting for command cmpl
*event.
**
**
*******************************************************************************/
...
*set
**                  to 60 and is configurable. Data longer than the maximum
*bytes
**                  will be truncated.
**
...
**
*******************************************************************************/
BTM_API extern void BTM_SetARCMode(UINT8 iface, UINT8 arc_mode,
...
**
*******************************************************************************/
BTM_API extern void BTM_PCM2Setup_Write(BOOLEAN clk_master,
                                        tBTM_VSC_CMPL_CB* p_arc_cb);
