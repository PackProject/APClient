...
/* tUIPC_STATUS codes*/
enum { UIPC_STATUS_SUCCESS, UIPC_STATUS_FAIL };
...
typedef struct {
    ...
    UINT8 num_streams; /* Number of simultaneous streams supported by the light
                          stack */
} tUIPC_OPEN_RSP;
...
typedef struct t_l2c_sync_to_lite_req {
    ...
    UINT8
    multi_av_data_cong_start;     /* Multi-AV queue size to start congestion */
...
typedef struct t_l2c_sync_to_lite_resp {
    ...
    UINT16
    light_xmit_unacked; /* unacked packet more than quota in light stack */
    UINT8 num_stream;
...
typedef struct {
    UINT8 opcode; /* A2DP_START_RESP, A2DP_STOP_RESP, A2DP_CLEANUP_RESP,
                     A2DP_SUSPEND_RESP */
    UINT16 lcid;
} tA2DP_GENERIC_RESP;
...
#define CODEC_INFO_AAC_3_CH                                                    \
    3 /*center front speaker, left right front speaker */
#define CODEC_INFO_AAC_4_CH                                                    \
    4 /*center/rear front speaker, left/right front speaker */
#define CODEC_INFO_AAC_5_CH                                                    \
    5 /*center, left, right front speaker, left/right surround */
#define CODEC_INFO_AAC_6_CH                                                    \
    6 /*center, left, right front speaker, left/right surround, LFE */
#define CODEC_INFO_AAC_7_CH                                                    \
    7 /*(left, right)center/left,right front speaker, left/right surround, LFE \
       */
