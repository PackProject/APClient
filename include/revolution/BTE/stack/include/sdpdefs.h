...
#define UUID_SERVCLASS_ADV_AUDIO_DISTRIBUTION                                  \
    0X110D /* Advanced Audio Distribution profile */
#define UUID_SERVCLASS_AV_REMOTE_CONTROL                                       \
    0X110E /* Audio/Video Control profile */
#define UUID_SERVCLASS_AV_REM_CTRL_CONTROL                                     \
    0X110F /* Audio/Video Control profile */
...
#define UUID_SERVCLASS_COMMON_ISDN_ACCESS                                      \
    0X1128 /* CAPI Message Transport Protocol*/
#define UUID_SERVCLASS_VIDEO_CONFERENCING_GW                                   \
    0X1129 /* Video Conferencing profile */
#define UUID_SERVCLASS_UDI_MT                                                  \
    0X112A /* Unrestricted Digital Information profile */
#define UUID_SERVCLASS_UDI_TA                                                  \
    0X112B                        /* Unrestricted Digital Information profile */
...
#define UUID_SERVCLASS_VIDEO_SOURCE                                            \
    0X1303 /* Video Distribution Profile (VDP) */
#define UUID_SERVCLASS_VIDEO_SINK                                              \
    0X1304 /* Video Distribution Profile (VDP)                                 \
            */
#define UUID_SERVCLASS_VIDEO_DISTRIBUTION                                      \
    0X1305                                /* Video Distribution Profile (VDP) */
...
#define UUID_SERVCLASS_MESSAGE_NOTIFICATION                                    \
    0X1133 /* Message Notification Service UUID */
...
/* Constants used for display purposes only.  These define ovelapping attribute
 * values */
