...
typedef struct {
    ...
    UINT8* raw_data; /* Received record from server. allocated/released by
                        client  */
...
**
*******************************************************************************/
SDP_API extern BOOLEAN
SDP_ServiceSearchAttributeRequest(UINT8* p_bd_addr, tSDP_DISCOVERY_DB* p_db,
                                  tSDP_DISC_CMPL_CB* p_cb);
...
*******************************************************************************/
SDP_API extern BOOLEAN
SDP_ServiceSearchAttributeRequest2(UINT8* p_bd_addr, tSDP_DISCOVERY_DB* p_db,
...
**
*******************************************************************************/
SDP_API extern tSDP_DISC_REC*
SDP_FindServiceUUIDInDb(tSDP_DISCOVERY_DB* p_db, tBT_UUID* p_uuid,
                        tSDP_DISC_REC* p_start_rec);
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_FindServiceUUIDInRec_128bit(tSDP_DISC_REC* p_rec,
                                                       tBT_UUID* p_uuid);
...
*******************************************************************************/
SDP_API extern tSDP_DISC_REC*
SDP_FindServiceInDb_128bit(tSDP_DISCOVERY_DB* p_db, tSDP_DISC_REC* p_start_rec);
...
*******************************************************************************/
SDP_API extern BOOLEAN
SDP_FindProtocolListElemInRec(tSDP_DISC_REC* p_rec, UINT16 layer_uuid,
...
*******************************************************************************/
SDP_API extern BOOLEAN
SDP_FindAddProtoListsElemInRec(tSDP_DISC_REC* p_rec, UINT16 layer_uuid,
                               tSDP_PROTOCOL_ELEM* p_elem);
...
**
*******************************************************************************/
SDP_API extern INT32 SDP_ReadRecord(UINT32 handle, UINT8* p_data,
                                    INT32* p_data_len);
...
*******************************************************************************/
SDP_API extern BOOLEAN
SDP_AddAdditionProtoLists(UINT32 handle, UINT16 num_elem,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddLanguageBaseAttrIDList(UINT32 handle, UINT16 lang,
                                                     UINT16 char_enc,
                                                     UINT16 base_id);
...
**                  p_handle - if p_handle == NULL, the primary record is
*returned
**
...
*SDP_ConnOpen
**
** Returns          TRUE if connection is closed, FALSE if failed to find the
*handle.
**
*******************************************************************************/
...
**
*******************************************************************************/
SDP_API BOOLEAN SDP_FindServiceUUIDInRec(tSDP_DISC_REC* p_rec,
                                         tBT_UUID* p_uuid);
