...
/* 32 and 64 bit mult will be performed using SINT64 ( usualy __int64 ) cast
 ...
 * quantizer */
/* setting this flag to FALSE add whistling noise at 5.5 and 11 KHz usualy not
 * perceptible by human's hears. */
...
/* TRUE -> application should provide PCM buffer, FALSE PCM buffer reside in
 * SBC_ENC_PARAMS */
...
#else
    SINT16 as16PcmBuffer[SBC_MAX_NUM_FRAME * SBC_MAX_NUM_OF_BLOCKS *
                         SBC_MAX_NUM_OF_CHANNELS * SBC_MAX_NUM_OF_SUBBANDS];
#endif

    SINT16 s16ScartchMemForBitAlloc[16];

    SINT32 s32SbBuffer[SBC_MAX_NUM_OF_CHANNELS * SBC_MAX_NUM_OF_SUBBANDS *
