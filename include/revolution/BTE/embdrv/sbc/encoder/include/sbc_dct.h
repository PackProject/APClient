...
#if (SBC_DSP_OPT == TRUE)
#define SBC_MULT_32_16_SIMPLIFIED(s16In2, s32In1, s32OutLow)                   \
    s32OutLow = SBC_Multiply_32_16_Simplified((SINT32)s16In2, s32In1);
#else
#if (SBC_IPAQ_OPT == TRUE)
/*#define SBC_MULT_32_16_SIMPLIFIED(s16In2, s32In1 , s32OutLow)
 * s32OutLow=(SINT32)((SINT32)(s16In2)*(SINT32)(s32In1>>15)); */
#define SBC_MULT_32_16_SIMPLIFIED(s16In2, s32In1, s32OutLow)                   \
    s32OutLow = (SINT32)(((SINT64)s16In2 * (SINT64)s32In1) >> 15);
...
#define SBC_MULT_64(s32In1, s32In2, s32OutLow, s32OutHi)                       \
    {                                                                          \
        s32OutLow =                                                            \
            (SINT32)(((SINT64)s32In1 * (SINT64)s32In2) & 0x00000000FFFFFFFF);  \
