...
**
** Description      BTIF storage API - Read HL application control block from
*NVRAM
**
...
**
** Description      BTIF storage API - Write HL application control block to
*NVRAM
**
** Returns          BT_STATUS_SUCCESS if the operation was successful,
**                  BT_STATUS_FAIL otherwise
...
** Function         btif_storage_read_hl_apps_cb
**
** Description      BTIF storage API - Read HL application configuration from
*NVRAM
**
** Returns          BT_STATUS_SUCCESS if the operation was successful,
**                  BT_STATUS_FAIL otherwise
**
*******************************************************************************/
bt_status_t btif_storage_read_hl_app_data(UINT8 app_idx, char* value,
                                          int value_size);
...
**
** Description      BTIF storage API - Write HL application configuration to
*NVRAM
**
** Returns          BT_STATUS_SUCCESS if the operation was successful,
**                  BT_STATUS_FAIL otherwise
**
*******************************************************************************/
bt_status_t btif_storage_write_hl_app_data(UINT8 app_idx, char* value,
                                           int value_size);
...
**
** Description      BTIF storage API - Read HL application MDL configuration
*from NVRAM
**
** Returns          BT_STATUS_SUCCESS if the operation was successful,
**                  BT_STATUS_FAIL otherwise
**
*******************************************************************************/
bt_status_t btif_storage_read_hl_mdl_data(UINT8 app_idx, char* value,
                                          int value_size);
...
**
** Description      BTIF storage API - Write HL application MDL configuration
*from NVRAM
**
** Returns          BT_STATUS_SUCCESS if the operation was successful,
**                  BT_STATUS_FAIL otherwise
**
*******************************************************************************/
bt_status_t btif_storage_write_hl_mdl_data(UINT8 app_idx, char* value,
                                           int value_size);
...
**
** Returns          BT_STATUS_SUCCESS if the auto pair blacklist is successfully
*populated
**                  BT_STATUS_FAIL otherwise
**
*******************************************************************************/
...
**
** Description      BTIF storage API  Checks if the given device is blacklisted
*for auto pairing
**
...
*******************************************************************************/
BOOLEAN
btif_storage_is_device_autopair_blacklisted(bt_bdaddr_t* remote_dev_addr);

/*******************************************************************************
**
** Function         btif_storage_add_device_to_autopair_blacklist
**
** Description      BTIF storage API - Add a remote device to the auto pairing
*blacklist
**
** Returns          BT_STATUS_SUCCESS if the device is successfully added to the
*auto pair blacklist
**                  BT_STATUS_FAIL otherwise
**
*******************************************************************************/
bt_status_t
btif_storage_add_device_to_autopair_blacklist(bt_bdaddr_t* remote_dev_addr);

/*******************************************************************************
**
** Function         btif_storage_is_fixed_pin_zeros_keyboard
**
** Description      BTIF storage API - checks if this device has fixed PIN key
*device list
**
** Returns          TRUE   if the device is found in the fixed pin keyboard
*device list
**                  FALSE otherwise
**
*******************************************************************************/
