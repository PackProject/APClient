...
typedef struct {
    ...
    const char* p_srv_desp; /* service description to be used in the SDP; null
                               terminated */
    const char* p_provider_name; /* provide name to be used in the SDP; null
                                    terminated */
} tBTA_HL_REG_PARAM;
...
typedef struct {
    ...
    BOOLEAN
    first_reliable; /* whether this is the first reliable data channel */
    UINT16 mtu;
...
**
*******************************************************************************/
BTA_API extern void BTA_HlRegister(UINT8 app_id, tBTA_HL_REG_PARAM* p_reg_param,
...
*******************************************************************************/
BTA_API extern void
BTA_HlDchReconnect(tBTA_HL_MCL_HANDLE mcl_handle,
...
*******************************************************************************/
BTA_API extern void
BTA_HlDchEchoTest(tBTA_HL_MCL_HANDLE mcl_handle,
...
*******************************************************************************/
BTA_API extern void
BTA_HlDchCreateRsp(tBTA_HL_MCL_HANDLE mcl_handle,
