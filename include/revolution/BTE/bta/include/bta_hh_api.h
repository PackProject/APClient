...
#else
BTA_API extern void BTA_HhEnable(tBTA_SEC sec_mask, BOOLEAN ucd_enabled,
...
#else
BTA_API extern void BTA_HhSendData(UINT8 dev_handle, BD_ADDR dev_bda,
                                   BT_HDR* p_buf);
#endif
...
**
*******************************************************************************/
BTA_API extern void BTA_HhParseBootRpt(tBTA_HH_BOOT_RPT* p_data,
