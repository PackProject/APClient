...
**                      BTA_AG_CO_AUD_STATE_OFF_XFER - Audio is closed pending
*transfer
**                      BTA_AG_CO_AUD_STATE_ON       - Audio has been turned on
**                      BTA_AG_CO_AUD_STATE_SETUP    - Audio is about to be
*turned on
**
** Returns          void
**
*******************************************************************************/
BTA_API extern void bta_ag_co_audio_state(UINT16 handle, UINT8 app_id,
                                          UINT8 state);
...
**
*******************************************************************************/
BTA_API extern void bta_ag_co_tx_write(UINT16 handle, UINT8* p_data,
                                       UINT16 len);
