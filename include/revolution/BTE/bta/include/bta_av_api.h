...
#define BTA_AV_CODEC_M12                                                       \
    A2D_MEDIA_CT_M12                      /* MPEG-1, 2 Audio media codec type  \
                                           */
#define BTA_AV_CODEC_M24 A2D_MEDIA_CT_M24 /* MPEG-2, 4 AAC media codec type */
#define BTA_AV_CODEC_ATRAC                                                     \
    A2D_MEDIA_CT_ATRAC /* ATRAC family media codec type */
#define BTA_AV_CODEC_H263_P0                                                   \
    VDP_MEDIA_CT_H263_P0 /* H.263 baseline (profile 0) */
#define BTA_AV_CODEC_MPEG4                                                     \
    VDP_MEDIA_CT_MPEG4 /* MPEG-4 Visual Simple Profile                         \
                        */
...
#define BTA_AV_CODEC_ID_IMG                                                    \
    VDP_CODEC_ID_IMG /* Non-VDP codec ID - images/slideshow */
...
#define BTA_AV_ERR_BAD_CP_TYPE                                                 \
    A2D_BAD_CP_TYPE /* The requested Content Protection Type is not supported  \
                     */
#define BTA_AV_ERR_BAD_CP_FORMAT                                               \
    A2D_BAD_CP_FORMAT /* The format of Content Protection Data is not correct  \
                       */
...
#define BTA_MAX_VENDOR_DEPENDENT_DATA_LEN                                      \
    (BTA_AVC_PACKET_LEN - BTA_VENDOR_DATA_OFFSET - BTA_VENDOR_HEADER_LEN)
...
typedef struct {
    ...
    const UINT32* p_meta_co_ids;  /* the metadata Get Capabilities response for
                                     company id */
    const UINT8* p_meta_evt_ids;  /* the the metadata Get Capabilities response
                                     for event id */
...
**
*******************************************************************************/
BTA_API void BTA_AvOpen(BD_ADDR bd_addr, tBTA_AV_HNDL handle, BOOLEAN use_rc,
                        tBTA_SEC sec_mask);
...
**
*******************************************************************************/
BTA_API void BTA_AvReconfig(tBTA_AV_HNDL hndl, BOOLEAN suspend,
                            UINT8 sep_info_idx, UINT8* p_codec_info,
...
**
*******************************************************************************/
BTA_API void BTA_AvProtectRsp(tBTA_AV_HNDL hndl, UINT8 error_code,
...
BTA_API void BTA_AvVendorCmd(UINT8 rc_handle, UINT8 label,
                             tBTA_AV_CODE cmd_code, UINT8* p_data, UINT16 len);
...
BTA_API void BTA_AvVendorRsp(UINT8 rc_handle, UINT8 label,
                             tBTA_AV_CODE rsp_code, UINT8* p_data, UINT16 len,
                             UINT32 company_id);
...
*role. 8                  The only command makes sense right now is the absolute
*volume command.
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_AvMetaCmd(UINT8 rc_handle, UINT8 label, tBTA_AV_CMD cmd_code,
                           BT_HDR* p_pkt);
