...
**
*******************************************************************************/
BTA_API tBTA_STATUS BTA_AgEnable(tBTA_AG_PARSE_MODE parse_mode,
...
BTA_API void BTA_AgRegister(tBTA_SERVICE_MASK services, tBTA_SEC sec_mask,
                            tBTA_AG_FEAT features, char* p_service_names[],
                            UINT8 app_id);
...
**
*******************************************************************************/
BTA_API void BTA_AgOpen(UINT16 handle, BD_ADDR bd_addr, tBTA_SEC sec_mask,
...
**
*******************************************************************************/
BTA_API void BTA_AgResult(UINT16 handle, tBTA_AG_RES result,
