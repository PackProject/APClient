...
#define BTA_JV_SET_DISCOVER_EVT                                                \
    1                               /* the result for BTA_JvSetDiscoverability \
                                     */
...
#define BTA_JV_CANCEL_DISCVRY_EVT                                              \
    15 /* the result for BTA_JvCancelDiscovery                                 \
        */
...
#define BTA_JV_RFCOMM_OPEN_EVT                                                 \
    25                             /* open status of RFCOMM Client connection  \
                                    */
...
#define BTA_JV_RFCOMM_SRV_OPEN_EVT                                             \
    33                    /* open status of Server RFCOMM connection */
...
**
** Description      This function sets the service class of local Class of
*Device
**
** Returns          BTA_JV_SUCCESS if successful.
**                  BTA_JV_FAIL if internal failure.
...
**
** Description      This function ensures that the connection to the given
*device
**                  is encrypted.
**                  When the operation is complete the tBTA_JV_DM_CBACK callback
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvStartDiscovery(BD_ADDR bd_addr,
                                                   UINT16 num_uuid,
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvGetServicesLength(BOOLEAN inc_hdr,
...
**                  tBTA_JV_DM_CBACK callback function will be called with a
**                  BTA_JV_SERVICE_SEL_EVT with the length of the service
*record.
...
**                  last BTA_JvServiceSelect. The contents will be returned
*under
...
**
** Description      Add an attribute to a service record in the local SDP
*database.
**                  When the operation is complete the tBTA_JV_DM_CBACK callback
...
**
** Description      Delete an attribute from a service record in the local SDP
*database.
**                  When the operation is complete the tBTA_JV_DM_CBACK callback
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvDeleteAttribute(UINT32 handle,
                                                    UINT16 attr_id);
...
**
*******************************************************************************/
BTA_API extern INT32 BTA_JvReadRecord(UINT32 handle, UINT8* p_data,
                                      INT32* p_data_len);
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS
BTA_JvL2capConnect(tBTA_SEC sec_mask, tBTA_JV_ROLE role, UINT16 remote_psm,
                   UINT16 rx_mtu, BD_ADDR peer_bd_addr,
...
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS
BTA_JvL2capStartServer(tBTA_SEC sec_mask, tBTA_JV_ROLE role, UINT16 local_psm,
                       UINT16 rx_mtu, tBTA_JV_L2CAP_CBACK* p_cback);
...
**                  If there are more data queued in L2CAP than len, the extra
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvL2capReady(UINT32 handle,
                                               UINT32* p_data_size);
...
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS
BTA_JvRfcommConnect(tBTA_SEC sec_mask, tBTA_JV_ROLE role, UINT8 remote_scn,
                    BD_ADDR peer_bd_addr, tBTA_JV_RFCOMM_CBACK* p_cback,
                    void* user_data);
...
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS
BTA_JvRfcommStartServer(tBTA_SEC sec_mask, tBTA_JV_ROLE role, UINT8 local_scn,
                        UINT8 max_session, tBTA_JV_RFCOMM_CBACK* p_cback,
                        void* user_data);
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvRfcommReady(UINT32 handle,
                                                UINT32* p_data_size);
