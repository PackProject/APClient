...
extern void bta_hh_parse_keybd_rpt(tBTA_HH_BOOT_RPT* p_kb_data, UINT8* p_report,
                                   UINT16 report_len);
extern void bta_hh_parse_mice_rpt(tBTA_HH_BOOT_RPT* p_kb_data, UINT8* p_report,
                                  UINT16 report_len);
...
extern void bta_hh_add_device_to_list(tBTA_HH_DEV_CB* p_cb, UINT8 handle,
                                      ...
                                      UINT8 sub_class, UINT16 max_latency,
                                      UINT16 min_tout, UINT8 app_id);
extern void bta_hh_update_di_info(tBTA_HH_DEV_CB* p_cb, UINT16 vendor_id,
