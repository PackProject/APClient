...
extern void bta_gattc_sm_execute(tBTA_GATTC_CLCB* p_clcb, UINT16 event,
...
extern void bta_gattc_process_api_open(tBTA_GATTC_CB* p_cb,
                                       tBTA_GATTC_DATA* p_msg);
extern void bta_gattc_process_api_open_cancel(tBTA_GATTC_CB* p_cb,
                                              tBTA_GATTC_DATA* p_msg);
extern void bta_gattc_deregister(tBTA_GATTC_CB* p_cb, tBTA_GATTC_DATA* p_data);
extern void bta_gattc_int_deregister(tBTA_GATTC_CB* p_cb,
                                     tBTA_GATTC_DATA* p_data);
...
extern void bta_gattc_cache_open(tBTA_GATTC_CLCB* p_clcb,
                                 tBTA_GATTC_DATA* p_data);
...
/* utility functions */
extern tBTA_GATTC_CLCB* bta_gattc_find_clcb_by_cif(UINT8 client_if,
                                                   BD_ADDR remote_bda); // todo
...
extern BOOLEAN bta_gattc_enqueue(tBTA_GATTC_CLCB* p_clcb,
                                 tBTA_GATTC_DATA* p_data);

extern UINT16 bta_gattc_id2handle(tBTA_GATTC_SERV* p_srcb,
                                  tBTA_GATT_SRVC_ID* p_service_id,
                                  tBTA_GATT_ID* p_char_id, tBT_UUID descr_uuid);
extern BOOLEAN bta_gattc_handle2id(tBTA_GATTC_SERV* p_srcb, UINT16 handle,
                                   tBTA_GATT_SRVC_ID* service_id,
                                   tBTA_GATT_ID* char_id, tBT_UUID* p_type);
extern BOOLEAN bta_gattc_uuid_compare(tBT_UUID src, tBT_UUID tar,
                                      BOOLEAN is_precise);
extern void bta_gattc_pack_attr_uuid(tBTA_GATTC_CACHE_ATTR* p_attr,
                                     tBT_UUID* p_uuid);
extern BOOLEAN bta_gattc_check_notif_registry(tBTA_GATTC_RCB* p_clreg,
                                              tBTA_GATTC_SERV* p_srcb,
                                              tBTA_GATTC_NOTIFY* p_notify);
extern tBTA_GATT_STATUS
bta_gattc_pack_read_cb_data(tBTA_GATTC_SERV* p_srcb, tBT_UUID descr_uuid,
                            tGATT_VALUE* p_attr, tBTA_GATT_READ_VAL* p_value);
extern BOOLEAN bta_gattc_mark_bg_conn(tBTA_GATTC_IF client_if,
                                      BD_ADDR remote_bda, BOOLEAN add);
extern BOOLEAN bta_gattc_check_bg_conn(tBTA_GATTC_IF client_if,
                                       BD_ADDR remote_bda);
extern UINT8 bta_gattc_num_reg_app(void);
extern void bta_gattc_clear_notif_registration(UINT16 conn_id);

/* discovery functions */
extern void bta_gattc_disc_res_cback(UINT16 conn_id, tGATT_DISC_TYPE disc_type,
                                     tGATT_DISC_RES* p_data);
extern void bta_gattc_disc_cmpl_cback(UINT16 conn_id, tGATT_DISC_TYPE disc_type,
                                      tGATT_STATUS status);
extern tBTA_GATT_STATUS
...
extern tBTA_GATT_STATUS bta_gattc_query_cache(UINT16 conn_id, UINT8 query_type,
