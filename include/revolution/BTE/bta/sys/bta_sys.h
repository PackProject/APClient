...
extern void bta_sys_start_timer(TIMER_LIST_ENT* p_tle, UINT16 type,
                                INT32 timeout);
...
extern void bta_sys_chg_ssr_config(UINT8 id, UINT8 app_id, UINT16 max_latency,
                                   UINT16 min_tout);
#endif

extern void bta_sys_role_chg_register(tBTA_SYS_CONN_CBACK* p_cback);
extern void bta_sys_notify_role_chg(BD_ADDR_PTR p_bda, UINT8 new_role,
                                    UINT8 hci_status);
extern void bta_sys_collision_register(UINT8 bta_id,
