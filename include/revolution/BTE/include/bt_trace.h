...
/* Trace type definitions. Note that these are mutually exclusive in a trace.
This means that any trace can be either error,warning,api,event or dbg */
...
#define BTTRC_TOKEN_SM_STATE                                                   \
    0xFFFF /* Token indicating the State of a State m/c */

// btla-specific ++
typedef struct {
    tBTTRC_LAYER_ID layer_id;
    tBTTRC_TYPE
        type; /* TODO: use tBTTRC_TYPE instead of "classical level 0-5" */
} tBTTRC_LEVEL;
...
extern void LogMsg_2(UINT32 trace_set_mask, const char* fmt_str, UINT32 p1,
                     UINT32 p2);
extern void LogMsg_3(UINT32 trace_set_mask, const char* fmt_str, UINT32 p1,
                     UINT32 p2, UINT32 p3);
extern void LogMsg_4(UINT32 trace_set_mask, const char* fmt_str, UINT32 p1,
                     UINT32 p2, UINT32 p3, UINT32 p4);
extern void LogMsg_5(UINT32 trace_set_mask, const char* fmt_str, UINT32 p1,
...
EXPORT_API extern void BTTRC_StackTrace0(tBTTRC_LAYER_ID layer_id,
                                         tBTTRC_TYPE type, UINT16 token);
EXPORT_API extern void BTTRC_StackTrace1(tBTTRC_LAYER_ID layer_id,
                                         tBTTRC_TYPE type, UINT16 token,
                                         tBTTRC_PARAM_TYPE p1_type,
                                         UINT32 p1_val);
EXPORT_API extern void
BTTRC_StackTrace2(tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
                  tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val,
                  tBTTRC_PARAM_TYPE p2_type, UINT32 p2_val);
EXPORT_API extern void
BTTRC_StackTrace3(tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
                  tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val,
                  tBTTRC_PARAM_TYPE p2_type, UINT32 p2_val,
                  tBTTRC_PARAM_TYPE p3_type, UINT32 p3_val);
EXPORT_API extern void
BTTRC_StackTrace4(tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
                  tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val,
                  tBTTRC_PARAM_TYPE p2_type, UINT32 p2_val,
                  tBTTRC_PARAM_TYPE p3_type, UINT32 p3_val,
                  tBTTRC_PARAM_TYPE p4_type, UINT32 p4_val);
EXPORT_API extern void
BTTRC_StackTrace5(tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
                  tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val,
                  tBTTRC_PARAM_TYPE p2_type, UINT32 p2_val,
                  tBTTRC_PARAM_TYPE p3_type, UINT32 p3_val,
                  tBTTRC_PARAM_TYPE p4_type, UINT32 p4_val,
                  tBTTRC_PARAM_TYPE p5_type, UINT32 p5_val);
EXPORT_API extern void BTTRC_StackTrace6(
    tBTTRC_LAYER_ID layer_id, tBTTRC_TYPE type, UINT16 token,
    tBTTRC_PARAM_TYPE p1_type, UINT32 p1_val, tBTTRC_PARAM_TYPE p2_type,
    UINT32 p2_val, tBTTRC_PARAM_TYPE p3_type, UINT32 p3_val,
    tBTTRC_PARAM_TYPE p4_type, UINT32 p4_val, tBTTRC_PARAM_TYPE p5_type,
    UINT32 p5_val, tBTTRC_PARAM_TYPE p6_type, UINT32 p6_val);

// btla-specific ++
/* p_levels must be a 0 terminated list ! */
// EXPORT_API extern tBTTRC_LEVEL * BTA_SysSetTraceLevel( tBTTRC_LEVEL *
// p_levels );
//  btla-specific --
...
#define BTTRC_EVENT(lid, event, state)                                         \
    {                                                                          \
        BTTRC_StackTrace1(lid, BTTRC_TYPE_EVENT, event, BTTRC_PARAM_UINT8,     \
                          state);                                              \
    }
...
#define BTTRC_STATE(lid, state)                                                \
    {                                                                          \
        BTTRC_StackTrace1(lid, BTTRC_TYPE_EVENT, BTTRC_TOKEN_SM_STATE,         \
                          BTTRC_PARAM_UINT8, state);                           \
    }
...
#define BTTRC_API3(lid, api, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v)               \
    {                                                                          \
        BTTRC_StackTrace3(lid, BTTRC_TYPE_API, api, p1_t, p1_v, p2_t, p2_v,    \
                          p3_t, p3_v);                                         \
    }
#define BTTRC_API4(lid, api, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v)   \
    {                                                                          \
        BTTRC_StackTrace4(lid, BTTRC_TYPE_API, api, p1_t, p1_v, p2_t, p2_v,    \
                          p3_t, p3_v, p4_t, p4_v);                             \
    }
#define BTTRC_API5(lid, api, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v,   \
                   p5_t, p5_v)                                                 \
    {                                                                          \
        BTTRC_StackTrace5(lid, BTTRC_TYPE_API, api, p1_t, p1_v, p2_t, p2_v,    \
                          p3_t, p3_v, p4_t, p4_v, p5_t, p5_v);                 \
    }
#define BTTRC_API6(lid, api, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v,   \
                   p5_t, p5_v, p6_t, p6_v)                                     \
    {                                                                          \
        BTTRC_StackTrace6(lid, BTTRC_TYPE_API, api, p1_t, p1_v, p2_t, p2_v,    \
                          p3_t, p3_v, p4_t, p4_v, p5_t, p5_v, p6_t, p6_v);     \
    }
...
#define BTTRC_DBG3(lid, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v)               \
    {                                                                          \
        BTTRC_StackTrace3(lid, BTTRC_TYPE_DBG, dbg, p1_t, p1_v, p2_t, p2_v,    \
                          p3_t, p3_v);                                         \
    }
#define BTTRC_DBG4(lid, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v)   \
    {                                                                          \
        BTTRC_StackTrace4(lid, BTTRC_TYPE_DBG, dbg, p1_t, p1_v, p2_t, p2_v,    \
                          p3_t, p3_v, p4_t, p4_v);                             \
    }
#define BTTRC_DBG5(lid, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v,   \
                   p5_t, p5_v)                                                 \
    {                                                                          \
        BTTRC_StackTrace5(lid, BTTRC_TYPE_DBG, dbg, p1_t, p1_v, p2_t, p2_v,    \
                          p3_t, p3_v, p4_t, p4_v, p5_t, p5_v);                 \
    }
#define BTTRC_DBG6(lid, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t, p4_v,   \
                   p5_t, p5_v, p6_t, p6_v)                                     \
    {                                                                          \
        BTTRC_StackTrace6(lid, BTTRC_TYPE_DBG, dbg, p1_t, p1_v, p2_t, p2_v,    \
                          p3_t, p3_v, p4_t, p4_v, p5_t, p5_v, p6_t, p6_v);     \
    }
...
#define BTTRC_AVDT_SCB_DBG4(dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t,     \
                            p4_v)                                              \
    BTTRC_DBG4(BTTRC_ID_AVDT_SCB, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v,     \
               p4_t, p4_v)
#define BTTRC_AVDT_SCB_DBG5(dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t,     \
                            p4_v, p5_t, p5_v)                                  \
    BTTRC_DBG5(BTTRC_ID_AVDT_SCB, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v,     \
               p4_t, p4_v, p5_t, p5_v)
#define BTTRC_AVDT_SCB_DBG6(dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t,     \
                            p4_v, p5_t, p5_v, p6_t, p6_v)                      \
    BTTRC_DBG6(BTTRC_ID_AVDT_SCB, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v,     \
               p4_t, p4_v, p5_t, p5_v, p6_t, p6_v)
/***************************************************************************************/
/*AVDT_CCB MACROS */
...
#define BTTRC_AVDT_CCB_DBG4(dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t,     \
                            p4_v)                                              \
    BTTRC_DBG4(BTTRC_ID_AVDT_CCB, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v,     \
               p4_t, p4_v)
#define BTTRC_AVDT_CCB_DBG5(dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t,     \
                            p4_v, p5_t, p5_v)                                  \
    BTTRC_DBG5(BTTRC_ID_AVDT_CCB, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v,     \
               p4_t, p4_v, p5_t, p5_v)
#define BTTRC_AVDT_CCB_DBG6(dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v, p4_t,     \
                            p4_v, p5_t, p5_v, p6_t, p6_v)                      \
    BTTRC_DBG6(BTTRC_ID_AVDT_CCB, dbg, p1_t, p1_v, p2_t, p2_v, p3_t, p3_v,     \
               p4_t, p4_v, p5_t, p5_v, p6_t, p6_v)
/***************************************************************************************/
...
#define BT_ERROR_TRACE_1(l, m, p1)                                             \
    LogMsg_1(TRACE_CTRL_GENERAL | (l) | TRACE_ORG_STACK | TRACE_TYPE_ERROR,    \
             (m), (UINT32)(p1))
#define BT_ERROR_TRACE_2(l, m, p1, p2)                                         \
    LogMsg_2(TRACE_CTRL_GENERAL | (l) | TRACE_ORG_STACK | TRACE_TYPE_ERROR,    \
             (m), (UINT32)(p1), (UINT32)(p2))
#define BT_ERROR_TRACE_3(l, m, p1, p2, p3)                                     \
    LogMsg_3(TRACE_CTRL_GENERAL | (l) | TRACE_ORG_STACK | TRACE_TYPE_ERROR,    \
...
#define HCI_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_HCI, TRACE_TYPE_ERROR, m);                  \
    }
#define HCI_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_HCI, TRACE_TYPE_ERROR, m, p1);              \
    }
#define HCI_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_HCI, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define HCI_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_HCI, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define HCI_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_HCI, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define HCI_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_HCI, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define HCI_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_HCI, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define HCI_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_HCI, TRACE_TYPE_WARNING, m);                \
    }
#define HCI_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_HCI, TRACE_TYPE_WARNING, m, p1);            \
    }
#define HCI_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_HCI, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define HCI_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_HCI, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define HCI_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_HCI, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define HCI_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_HCI, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define HCI_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_HCI, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define HCI_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_HCI, TRACE_TYPE_EVENT, m);                  \
    }
#define HCI_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_HCI, TRACE_TYPE_EVENT, m, p1);              \
    }
#define HCI_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_HCI, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define HCI_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_HCI, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define HCI_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_HCI, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define HCI_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_HCI, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define HCI_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_HCI, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define HCI_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_HCI, TRACE_TYPE_DEBUG, m);                  \
    }
#define HCI_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_HCI, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define HCI_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_HCI, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define HCI_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_HCI, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define HCI_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_HCI, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define HCI_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_HCI, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define HCI_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (btu_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_HCI, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define BTM_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_BTM, TRACE_TYPE_ERROR, m);                  \
    }
#define BTM_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_BTM, TRACE_TYPE_ERROR, m, p1);              \
    }
#define BTM_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_BTM, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define BTM_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_BTM, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define BTM_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_BTM, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define BTM_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_BTM, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define BTM_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_BTM, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define BTM_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_BTM, TRACE_TYPE_WARNING, m);                \
    }
#define BTM_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_BTM, TRACE_TYPE_WARNING, m, p1);            \
    }
#define BTM_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_BTM, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define BTM_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_BTM, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define BTM_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_BTM, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define BTM_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_BTM, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define BTM_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_BTM, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define BTM_TRACE_API0(m)                                                      \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_BTM, TRACE_TYPE_API, m);                    \
    }
#define BTM_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_BTM, TRACE_TYPE_API, m, p1);                \
    }
#define BTM_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_BTM, TRACE_TYPE_API, m, p1, p2);            \
    }
#define BTM_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_BTM, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define BTM_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_BTM, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define BTM_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_BTM, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define BTM_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_BTM, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define BTM_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_BTM, TRACE_TYPE_EVENT, m);                  \
    }
#define BTM_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_BTM, TRACE_TYPE_EVENT, m, p1);              \
    }
#define BTM_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_BTM, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define BTM_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_BTM, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define BTM_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_BTM, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define BTM_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_BTM, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define BTM_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_BTM, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define BTM_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_BTM, TRACE_TYPE_DEBUG, m);                  \
    }
#define BTM_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_BTM, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define BTM_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_BTM, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define BTM_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_BTM, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define BTM_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_BTM, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define BTM_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_BTM, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define BTM_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (btm_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_BTM, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define L2CAP_TRACE_ERROR0(m)                                                  \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_ERROR)                    \
            BT_TRACE_0(TRACE_LAYER_L2CAP, TRACE_TYPE_ERROR, m);                \
    }
#define L2CAP_TRACE_ERROR1(m, p1)                                              \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_ERROR)                    \
            BT_TRACE_1(TRACE_LAYER_L2CAP, TRACE_TYPE_ERROR, m, p1);            \
    }
#define L2CAP_TRACE_ERROR2(m, p1, p2)                                          \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_ERROR)                    \
            BT_TRACE_2(TRACE_LAYER_L2CAP, TRACE_TYPE_ERROR, m, p1, p2);        \
    }
#define L2CAP_TRACE_ERROR3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_ERROR)                    \
            BT_TRACE_3(TRACE_LAYER_L2CAP, TRACE_TYPE_ERROR, m, p1, p2, p3);    \
    }
#define L2CAP_TRACE_ERROR4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_ERROR)                    \
            BT_TRACE_4(TRACE_LAYER_L2CAP, TRACE_TYPE_ERROR, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define L2CAP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_ERROR)                    \
            BT_TRACE_5(TRACE_LAYER_L2CAP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define L2CAP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_ERROR)                    \
            BT_TRACE_6(TRACE_LAYER_L2CAP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define L2CAP_TRACE_WARNING0(m)                                                \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_WARNING)                  \
            BT_TRACE_0(TRACE_LAYER_L2CAP, TRACE_TYPE_WARNING, m);              \
    }
#define L2CAP_TRACE_WARNING1(m, p1)                                            \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_WARNING)                  \
            BT_TRACE_1(TRACE_LAYER_L2CAP, TRACE_TYPE_WARNING, m, p1);          \
    }
#define L2CAP_TRACE_WARNING2(m, p1, p2)                                        \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_WARNING)                  \
            BT_TRACE_2(TRACE_LAYER_L2CAP, TRACE_TYPE_WARNING, m, p1, p2);      \
    }
#define L2CAP_TRACE_WARNING3(m, p1, p2, p3)                                    \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_WARNING)                  \
            BT_TRACE_3(TRACE_LAYER_L2CAP, TRACE_TYPE_WARNING, m, p1, p2, p3);  \
    }
#define L2CAP_TRACE_WARNING4(m, p1, p2, p3, p4)                                \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_WARNING)                  \
            BT_TRACE_4(TRACE_LAYER_L2CAP, TRACE_TYPE_WARNING, m, p1, p2, p3,   \
                       p4);                                                    \
    }
#define L2CAP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                            \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_WARNING)                  \
            BT_TRACE_5(TRACE_LAYER_L2CAP, TRACE_TYPE_WARNING, m, p1, p2, p3,   \
                       p4, p5);                                                \
    }
#define L2CAP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                        \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_WARNING)                  \
            BT_TRACE_6(TRACE_LAYER_L2CAP, TRACE_TYPE_WARNING, m, p1, p2, p3,   \
                       p4, p5, p6);                                            \
    }
...
#define L2CAP_TRACE_API0(m)                                                    \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_API)                      \
            BT_TRACE_0(TRACE_LAYER_L2CAP, TRACE_TYPE_API, m);                  \
    }
#define L2CAP_TRACE_API1(m, p1)                                                \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_API)                      \
            BT_TRACE_1(TRACE_LAYER_L2CAP, TRACE_TYPE_API, m, p1);              \
    }
#define L2CAP_TRACE_API2(m, p1, p2)                                            \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_API)                      \
            BT_TRACE_2(TRACE_LAYER_L2CAP, TRACE_TYPE_API, m, p1, p2);          \
    }
#define L2CAP_TRACE_API3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_API)                      \
            BT_TRACE_3(TRACE_LAYER_L2CAP, TRACE_TYPE_API, m, p1, p2, p3);      \
    }
#define L2CAP_TRACE_API4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_API)                      \
            BT_TRACE_4(TRACE_LAYER_L2CAP, TRACE_TYPE_API, m, p1, p2, p3, p4);  \
    }
#define L2CAP_TRACE_API5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_API)                      \
            BT_TRACE_5(TRACE_LAYER_L2CAP, TRACE_TYPE_API, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define L2CAP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_API)                      \
            BT_TRACE_6(TRACE_LAYER_L2CAP, TRACE_TYPE_API, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define L2CAP_TRACE_EVENT0(m)                                                  \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_EVENT)                    \
            BT_TRACE_0(TRACE_LAYER_L2CAP, TRACE_TYPE_EVENT, m);                \
    }
#define L2CAP_TRACE_EVENT1(m, p1)                                              \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_EVENT)                    \
            BT_TRACE_1(TRACE_LAYER_L2CAP, TRACE_TYPE_EVENT, m, p1);            \
    }
#define L2CAP_TRACE_EVENT2(m, p1, p2)                                          \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_EVENT)                    \
            BT_TRACE_2(TRACE_LAYER_L2CAP, TRACE_TYPE_EVENT, m, p1, p2);        \
    }
#define L2CAP_TRACE_EVENT3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_EVENT)                    \
            BT_TRACE_3(TRACE_LAYER_L2CAP, TRACE_TYPE_EVENT, m, p1, p2, p3);    \
    }
#define L2CAP_TRACE_EVENT4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_EVENT)                    \
            BT_TRACE_4(TRACE_LAYER_L2CAP, TRACE_TYPE_EVENT, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define L2CAP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_EVENT)                    \
            BT_TRACE_5(TRACE_LAYER_L2CAP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define L2CAP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_EVENT)                    \
            BT_TRACE_6(TRACE_LAYER_L2CAP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define L2CAP_TRACE_DEBUG0(m)                                                  \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_DEBUG)                    \
            BT_TRACE_0(TRACE_LAYER_L2CAP, TRACE_TYPE_DEBUG, m);                \
    }
#define L2CAP_TRACE_DEBUG1(m, p1)                                              \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_DEBUG)                    \
            BT_TRACE_1(TRACE_LAYER_L2CAP, TRACE_TYPE_DEBUG, m, p1);            \
    }
#define L2CAP_TRACE_DEBUG2(m, p1, p2)                                          \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_DEBUG)                    \
            BT_TRACE_2(TRACE_LAYER_L2CAP, TRACE_TYPE_DEBUG, m, p1, p2);        \
    }
#define L2CAP_TRACE_DEBUG3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_DEBUG)                    \
            BT_TRACE_3(TRACE_LAYER_L2CAP, TRACE_TYPE_DEBUG, m, p1, p2, p3);    \
    }
#define L2CAP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_DEBUG)                    \
            BT_TRACE_4(TRACE_LAYER_L2CAP, TRACE_TYPE_DEBUG, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define L2CAP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_DEBUG)                    \
            BT_TRACE_5(TRACE_LAYER_L2CAP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define L2CAP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (l2cb.l2cap_trace_level >= BT_TRACE_LEVEL_DEBUG)                    \
            BT_TRACE_6(TRACE_LAYER_L2CAP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define LLCP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_5(TRACE_LAYER_LLCP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define LLCP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_6(TRACE_LAYER_LLCP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define LLCP_TRACE_WARNING4(m, p1, p2, p3, p4)                                 \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_4(TRACE_LAYER_LLCP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4);                                                    \
    }
#define LLCP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                             \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_5(TRACE_LAYER_LLCP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5);                                                \
    }
#define LLCP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                         \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_6(TRACE_LAYER_LLCP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5, p6);                                            \
    }
...
#define LLCP_TRACE_API5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_5(TRACE_LAYER_LLCP, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define LLCP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_6(TRACE_LAYER_LLCP, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define LLCP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_5(TRACE_LAYER_LLCP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define LLCP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_6(TRACE_LAYER_LLCP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define LLCP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_5(TRACE_LAYER_LLCP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define LLCP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (llcp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_6(TRACE_LAYER_LLCP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define SDP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_SDP, TRACE_TYPE_ERROR, m);                  \
    }
#define SDP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_SDP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define SDP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_SDP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define SDP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_SDP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define SDP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_SDP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define SDP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_SDP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SDP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_SDP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define SDP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_SDP, TRACE_TYPE_WARNING, m);                \
    }
#define SDP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_SDP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define SDP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_SDP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define SDP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_SDP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define SDP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_SDP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define SDP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_SDP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define SDP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_SDP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define SDP_TRACE_API0(m)                                                      \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_SDP, TRACE_TYPE_API, m);                    \
    }
#define SDP_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_SDP, TRACE_TYPE_API, m, p1);                \
    }
#define SDP_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_SDP, TRACE_TYPE_API, m, p1, p2);            \
    }
#define SDP_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_SDP, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define SDP_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_SDP, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define SDP_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_SDP, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define SDP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_SDP, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define SDP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_SDP, TRACE_TYPE_EVENT, m);                  \
    }
#define SDP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_SDP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define SDP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_SDP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define SDP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_SDP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define SDP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_SDP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define SDP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_SDP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SDP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_SDP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define SDP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_SDP, TRACE_TYPE_DEBUG, m);                  \
    }
#define SDP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_SDP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define SDP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_SDP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define SDP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_SDP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define SDP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_SDP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define SDP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_SDP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SDP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (sdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_SDP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define RFCOMM_TRACE_ERROR0(m)                                                 \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_RFCOMM, TRACE_TYPE_ERROR, m);               \
    }
#define RFCOMM_TRACE_ERROR1(m, p1)                                             \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_RFCOMM, TRACE_TYPE_ERROR, m, p1);           \
    }
#define RFCOMM_TRACE_ERROR2(m, p1, p2)                                         \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_RFCOMM, TRACE_TYPE_ERROR, m, p1, p2);       \
    }
#define RFCOMM_TRACE_ERROR3(m, p1, p2, p3)                                     \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_RFCOMM, TRACE_TYPE_ERROR, m, p1, p2, p3);   \
    }
#define RFCOMM_TRACE_ERROR4(m, p1, p2, p3, p4)                                 \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_RFCOMM, TRACE_TYPE_ERROR, m, p1, p2, p3,    \
                       p4);                                                    \
    }
#define RFCOMM_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                             \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_RFCOMM, TRACE_TYPE_ERROR, m, p1, p2, p3,    \
                       p4, p5);                                                \
    }
#define RFCOMM_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                         \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_RFCOMM, TRACE_TYPE_ERROR, m, p1, p2, p3,    \
                       p4, p5, p6);                                            \
    }
...
#define RFCOMM_TRACE_WARNING0(m)                                               \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_RFCOMM, TRACE_TYPE_WARNING, m);             \
    }
#define RFCOMM_TRACE_WARNING1(m, p1)                                           \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_RFCOMM, TRACE_TYPE_WARNING, m, p1);         \
    }
#define RFCOMM_TRACE_WARNING2(m, p1, p2)                                       \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_RFCOMM, TRACE_TYPE_WARNING, m, p1, p2);     \
    }
#define RFCOMM_TRACE_WARNING3(m, p1, p2, p3)                                   \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_RFCOMM, TRACE_TYPE_WARNING, m, p1, p2, p3); \
    }
#define RFCOMM_TRACE_WARNING4(m, p1, p2, p3, p4)                               \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_RFCOMM, TRACE_TYPE_WARNING, m, p1, p2, p3,  \
                       p4);                                                    \
    }
#define RFCOMM_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                           \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_RFCOMM, TRACE_TYPE_WARNING, m, p1, p2, p3,  \
                       p4, p5);                                                \
    }
#define RFCOMM_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                       \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_RFCOMM, TRACE_TYPE_WARNING, m, p1, p2, p3,  \
                       p4, p5, p6);                                            \
    }
...
#define RFCOMM_TRACE_API0(m)                                                   \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_RFCOMM, TRACE_TYPE_API, m);                 \
    }
#define RFCOMM_TRACE_API1(m, p1)                                               \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_RFCOMM, TRACE_TYPE_API, m, p1);             \
    }
#define RFCOMM_TRACE_API2(m, p1, p2)                                           \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_RFCOMM, TRACE_TYPE_API, m, p1, p2);         \
    }
#define RFCOMM_TRACE_API3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_RFCOMM, TRACE_TYPE_API, m, p1, p2, p3);     \
    }
#define RFCOMM_TRACE_API4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_RFCOMM, TRACE_TYPE_API, m, p1, p2, p3, p4); \
    }
#define RFCOMM_TRACE_API5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_RFCOMM, TRACE_TYPE_API, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define RFCOMM_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_RFCOMM, TRACE_TYPE_API, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define RFCOMM_TRACE_EVENT0(m)                                                 \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_RFCOMM, TRACE_TYPE_EVENT, m);               \
    }
#define RFCOMM_TRACE_EVENT1(m, p1)                                             \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_RFCOMM, TRACE_TYPE_EVENT, m, p1);           \
    }
#define RFCOMM_TRACE_EVENT2(m, p1, p2)                                         \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_RFCOMM, TRACE_TYPE_EVENT, m, p1, p2);       \
    }
#define RFCOMM_TRACE_EVENT3(m, p1, p2, p3)                                     \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_RFCOMM, TRACE_TYPE_EVENT, m, p1, p2, p3);   \
    }
#define RFCOMM_TRACE_EVENT4(m, p1, p2, p3, p4)                                 \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_RFCOMM, TRACE_TYPE_EVENT, m, p1, p2, p3,    \
                       p4);                                                    \
    }
#define RFCOMM_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                             \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_RFCOMM, TRACE_TYPE_EVENT, m, p1, p2, p3,    \
                       p4, p5);                                                \
    }
#define RFCOMM_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                         \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_RFCOMM, TRACE_TYPE_EVENT, m, p1, p2, p3,    \
                       p4, p5, p6);                                            \
    }
...
#define RFCOMM_TRACE_DEBUG0(m)                                                 \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_RFCOMM, TRACE_TYPE_DEBUG, m);               \
    }
#define RFCOMM_TRACE_DEBUG1(m, p1)                                             \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_RFCOMM, TRACE_TYPE_DEBUG, m, p1);           \
    }
#define RFCOMM_TRACE_DEBUG2(m, p1, p2)                                         \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_RFCOMM, TRACE_TYPE_DEBUG, m, p1, p2);       \
    }
#define RFCOMM_TRACE_DEBUG3(m, p1, p2, p3)                                     \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_RFCOMM, TRACE_TYPE_DEBUG, m, p1, p2, p3);   \
    }
#define RFCOMM_TRACE_DEBUG4(m, p1, p2, p3, p4)                                 \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_RFCOMM, TRACE_TYPE_DEBUG, m, p1, p2, p3,    \
                       p4);                                                    \
    }
#define RFCOMM_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                             \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_RFCOMM, TRACE_TYPE_DEBUG, m, p1, p2, p3,    \
                       p4, p5);                                                \
    }
#define RFCOMM_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                         \
    {                                                                          \
        if (rfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_RFCOMM, TRACE_TYPE_DEBUG, m, p1, p2, p3,    \
                       p4, p5, p6);                                            \
    }
...
#define SPP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_SPP, TRACE_TYPE_ERROR, m);                  \
    }
#define SPP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_SPP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define SPP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_SPP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define SPP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_SPP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define SPP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_SPP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define SPP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_SPP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SPP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_SPP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define SPP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_SPP, TRACE_TYPE_WARNING, m);                \
    }
#define SPP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_SPP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define SPP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_SPP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define SPP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_SPP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define SPP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_SPP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define SPP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_SPP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define SPP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_SPP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define SPP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_SPP, TRACE_TYPE_EVENT, m);                  \
    }
#define SPP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_SPP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define SPP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_SPP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define SPP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_SPP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define SPP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_SPP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define SPP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_SPP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SPP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_SPP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define SPP_TRACE_API0(m)                                                      \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_SPP, TRACE_TYPE_API, m);                    \
    }
#define SPP_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_SPP, TRACE_TYPE_API, m, p1);                \
    }
#define SPP_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_SPP, TRACE_TYPE_API, m, p1, p2);            \
    }
#define SPP_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_SPP, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define SPP_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_SPP, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define SPP_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_SPP, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define SPP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_SPP, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }

#define SPP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_SPP, TRACE_TYPE_DEBUG, m);                  \
    }
#define SPP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_SPP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define SPP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_SPP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define SPP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_SPP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define SPP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_SPP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define SPP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_SPP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SPP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (spp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_SPP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define GAP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_GAP, TRACE_TYPE_ERROR, m);                  \
    }
#define GAP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_GAP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define GAP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_GAP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define GAP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_GAP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define GAP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_GAP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define GAP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_GAP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define GAP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_GAP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define GAP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_GAP, TRACE_TYPE_EVENT, m);                  \
    }
#define GAP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_GAP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define GAP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_GAP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define GAP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_GAP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define GAP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_GAP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define GAP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_GAP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define GAP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_GAP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define GAP_TRACE_API0(m)                                                      \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_GAP, TRACE_TYPE_API, m);                    \
    }
#define GAP_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_GAP, TRACE_TYPE_API, m, p1);                \
    }
#define GAP_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_GAP, TRACE_TYPE_API, m, p1, p2);            \
    }
#define GAP_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_GAP, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define GAP_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_GAP, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define GAP_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_GAP, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define GAP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_GAP, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define GAP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_GAP, TRACE_TYPE_WARNING, m);                \
    }
#define GAP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_GAP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define GAP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_GAP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define GAP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_GAP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define GAP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_GAP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define GAP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_GAP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define GAP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (gap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_GAP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define OBX_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_OBEX, TRACE_TYPE_ERROR, m);                 \
    }
#define OBX_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_OBEX, TRACE_TYPE_ERROR, m, p1);             \
    }
#define OBX_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_OBEX, TRACE_TYPE_ERROR, m, p1, p2);         \
    }
#define OBX_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_OBEX, TRACE_TYPE_ERROR, m, p1, p2, p3);     \
    }
#define OBX_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_OBEX, TRACE_TYPE_ERROR, m, p1, p2, p3, p4); \
    }
#define OBX_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_OBEX, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define OBX_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_OBEX, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define OBX_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_OBEX, TRACE_TYPE_WARNING, m);               \
    }
#define OBX_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_OBEX, TRACE_TYPE_WARNING, m, p1);           \
    }
#define OBX_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_OBEX, TRACE_TYPE_WARNING, m, p1, p2);       \
    }
#define OBX_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_OBEX, TRACE_TYPE_WARNING, m, p1, p2, p3);   \
    }
#define OBX_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_OBEX, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4);                                                    \
    }
#define OBX_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_OBEX, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5);                                                \
    }
#define OBX_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_OBEX, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5, p6);                                            \
    }

#define OBX_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_OBEX, TRACE_TYPE_EVENT, m);                 \
    }
#define OBX_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_OBEX, TRACE_TYPE_EVENT, m, p1);             \
    }
#define OBX_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_OBEX, TRACE_TYPE_EVENT, m, p1, p2);         \
    }
#define OBX_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_OBEX, TRACE_TYPE_EVENT, m, p1, p2, p3);     \
    }
#define OBX_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_OBEX, TRACE_TYPE_EVENT, m, p1, p2, p3, p4); \
    }
#define OBX_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_OBEX, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define OBX_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_OBEX, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define OBX_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_OBEX, TRACE_TYPE_DEBUG, m);                 \
    }
#define OBX_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_OBEX, TRACE_TYPE_DEBUG, m, p1);             \
    }
#define OBX_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_OBEX, TRACE_TYPE_DEBUG, m, p1, p2);         \
    }
#define OBX_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_OBEX, TRACE_TYPE_DEBUG, m, p1, p2, p3);     \
    }
#define OBX_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_OBEX, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4); \
    }
#define OBX_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_OBEX, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define OBX_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_OBEX, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define OBX_TRACE_API0(m)                                                      \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_OBEX, TRACE_TYPE_API, m);                   \
    }
#define OBX_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_OBEX, TRACE_TYPE_API, m, p1);               \
    }
#define OBX_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_OBEX, TRACE_TYPE_API, m, p1, p2);           \
    }
#define OBX_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_OBEX, TRACE_TYPE_API, m, p1, p2, p3);       \
    }
#define OBX_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_OBEX, TRACE_TYPE_API, m, p1, p2, p3, p4);   \
    }
#define OBX_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_OBEX, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define OBX_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (obx_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_OBEX, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define GOEP_TRACE_ERROR0(m)                                                   \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_0(TRACE_LAYER_GOEP, TRACE_TYPE_ERROR, m);                 \
    }
#define GOEP_TRACE_ERROR1(m, p1)                                               \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_1(TRACE_LAYER_GOEP, TRACE_TYPE_ERROR, m, p1);             \
    }
#define GOEP_TRACE_ERROR2(m, p1, p2)                                           \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_2(TRACE_LAYER_GOEP, TRACE_TYPE_ERROR, m, p1, p2);         \
    }
#define GOEP_TRACE_ERROR3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_3(TRACE_LAYER_GOEP, TRACE_TYPE_ERROR, m, p1, p2, p3);     \
    }
#define GOEP_TRACE_ERROR4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_4(TRACE_LAYER_GOEP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4); \
    }
#define GOEP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_5(TRACE_LAYER_GOEP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define GOEP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_6(TRACE_LAYER_GOEP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define GOEP_TRACE_WARNING0(m)                                                 \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_0(TRACE_LAYER_GOEP, TRACE_TYPE_WARNING, m);               \
    }
#define GOEP_TRACE_WARNING1(m, p1)                                             \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_1(TRACE_LAYER_GOEP, TRACE_TYPE_WARNING, m, p1);           \
    }
#define GOEP_TRACE_WARNING2(m, p1, p2)                                         \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_2(TRACE_LAYER_GOEP, TRACE_TYPE_WARNING, m, p1, p2);       \
    }
#define GOEP_TRACE_WARNING3(m, p1, p2, p3)                                     \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_3(TRACE_LAYER_GOEP, TRACE_TYPE_WARNING, m, p1, p2, p3);   \
    }
#define GOEP_TRACE_WARNING4(m, p1, p2, p3, p4)                                 \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_4(TRACE_LAYER_GOEP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4);                                                    \
    }
#define GOEP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                             \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_5(TRACE_LAYER_GOEP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5);                                                \
    }
#define GOEP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                         \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_6(TRACE_LAYER_GOEP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5, p6);                                            \
    }

#define GOEP_TRACE_EVENT0(m)                                                   \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_0(TRACE_LAYER_GOEP, TRACE_TYPE_EVENT, m);                 \
    }
#define GOEP_TRACE_EVENT1(m, p1)                                               \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_1(TRACE_LAYER_GOEP, TRACE_TYPE_EVENT, m, p1);             \
    }
#define GOEP_TRACE_EVENT2(m, p1, p2)                                           \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_2(TRACE_LAYER_GOEP, TRACE_TYPE_EVENT, m, p1, p2);         \
    }
#define GOEP_TRACE_EVENT3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_3(TRACE_LAYER_GOEP, TRACE_TYPE_EVENT, m, p1, p2, p3);     \
    }
#define GOEP_TRACE_EVENT4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_4(TRACE_LAYER_GOEP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4); \
    }
#define GOEP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_5(TRACE_LAYER_GOEP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define GOEP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_6(TRACE_LAYER_GOEP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define GOEP_TRACE_DEBUG0(m)                                                   \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_0(TRACE_LAYER_GOEP, TRACE_TYPE_DEBUG, m);                 \
    }
#define GOEP_TRACE_DEBUG1(m, p1)                                               \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_1(TRACE_LAYER_GOEP, TRACE_TYPE_DEBUG, m, p1);             \
    }
#define GOEP_TRACE_DEBUG2(m, p1, p2)                                           \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_2(TRACE_LAYER_GOEP, TRACE_TYPE_DEBUG, m, p1, p2);         \
    }
#define GOEP_TRACE_DEBUG3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_3(TRACE_LAYER_GOEP, TRACE_TYPE_DEBUG, m, p1, p2, p3);     \
    }
#define GOEP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_4(TRACE_LAYER_GOEP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4); \
    }
#define GOEP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_5(TRACE_LAYER_GOEP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define GOEP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_6(TRACE_LAYER_GOEP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define GOEP_TRACE_API0(m)                                                     \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_0(TRACE_LAYER_GOEP, TRACE_TYPE_API, m);                   \
    }
#define GOEP_TRACE_API1(m, p1)                                                 \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_1(TRACE_LAYER_GOEP, TRACE_TYPE_API, m, p1);               \
    }
#define GOEP_TRACE_API2(m, p1, p2)                                             \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_2(TRACE_LAYER_GOEP, TRACE_TYPE_API, m, p1, p2);           \
    }
#define GOEP_TRACE_API3(m, p1, p2, p3)                                         \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_3(TRACE_LAYER_GOEP, TRACE_TYPE_API, m, p1, p2, p3);       \
    }
#define GOEP_TRACE_API4(m, p1, p2, p3, p4)                                     \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_4(TRACE_LAYER_GOEP, TRACE_TYPE_API, m, p1, p2, p3, p4);   \
    }
#define GOEP_TRACE_API5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_5(TRACE_LAYER_GOEP, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define GOEP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (goep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_6(TRACE_LAYER_GOEP, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define BPP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_BPP, TRACE_TYPE_ERROR, m);                  \
    }
#define BPP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_BPP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define BPP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_BPP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define BPP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_BPP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define BPP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_BPP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define BPP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_BPP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define BPP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_BPP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define BPP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_BPP, TRACE_TYPE_WARNING, m);                \
    }
#define BPP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_BPP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define BPP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_BPP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define BPP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_BPP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define BPP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_BPP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define BPP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_BPP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define BPP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_BPP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define BPP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_BPP, TRACE_TYPE_EVENT, m);                  \
    }
#define BPP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_BPP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define BPP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_BPP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define BPP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_BPP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define BPP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_BPP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define BPP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_BPP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define BPP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_BPP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define BPP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_BPP, TRACE_TYPE_DEBUG, m);                  \
    }
#define BPP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_BPP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define BPP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_BPP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define BPP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_BPP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define BPP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_BPP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define BPP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_BPP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define BPP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_BPP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define BPP_TRACE_API0(m)                                                      \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_BPP, TRACE_TYPE_API, m);                    \
    }
#define BPP_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_BPP, TRACE_TYPE_API, m, p1);                \
    }
#define BPP_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_BPP, TRACE_TYPE_API, m, p1, p2);            \
    }
#define BPP_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_BPP, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define BPP_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_BPP, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define BPP_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_BPP, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define BPP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (bpp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_BPP, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define BIP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_BIP, TRACE_TYPE_ERROR, m);                  \
    }
#define BIP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_BIP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define BIP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_BIP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define BIP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_BIP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define BIP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_BIP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define BIP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_BIP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define BIP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_BIP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define BIP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_BIP, TRACE_TYPE_WARNING, m);                \
    }
#define BIP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_BIP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define BIP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_BIP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define BIP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_BIP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define BIP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_BIP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define BIP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_BIP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define BIP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_BIP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define BIP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_BIP, TRACE_TYPE_EVENT, m);                  \
    }
#define BIP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_BIP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define BIP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_BIP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define BIP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_BIP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define BIP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_BIP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define BIP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_BIP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define BIP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_BIP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define BIP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_BIP, TRACE_TYPE_DEBUG, m);                  \
    }
#define BIP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_BIP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define BIP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_BIP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define BIP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_BIP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define BIP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_BIP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define BIP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_BIP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define BIP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_BIP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define BIP_TRACE_API0(m)                                                      \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_BIP, TRACE_TYPE_API, m);                    \
    }
#define BIP_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_BIP, TRACE_TYPE_API, m, p1);                \
    }
#define BIP_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_BIP, TRACE_TYPE_API, m, p1, p2);            \
    }
#define BIP_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_BIP, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define BIP_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_BIP, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define BIP_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_BIP, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define BIP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (bip_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_BIP, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define TCS_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_TCS, TRACE_TYPE_ERROR, m);                  \
    }
#define TCS_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_TCS, TRACE_TYPE_ERROR, m, p1);              \
    }
#define TCS_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_TCS, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define TCS_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_TCS, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define TCS_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_TCS, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define TCS_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_TCS, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define TCS_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_TCS, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define TCS_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_TCS, TRACE_TYPE_WARNING, m);                \
    }
#define TCS_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_TCS, TRACE_TYPE_WARNING, m, p1);            \
    }
#define TCS_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_TCS, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define TCS_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_TCS, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define TCS_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_TCS, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define TCS_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_TCS, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define TCS_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_TCS, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define TCS_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_TCS, TRACE_TYPE_EVENT, m);                  \
    }
#define TCS_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_TCS, TRACE_TYPE_EVENT, m, p1);              \
    }
#define TCS_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_TCS, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define TCS_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_TCS, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define TCS_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_TCS, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define TCS_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_TCS, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define TCS_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_TCS, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define TCS_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_TCS, TRACE_TYPE_DEBUG, m);                  \
    }
#define TCS_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_TCS, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define TCS_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_TCS, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define TCS_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_TCS, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define TCS_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_TCS, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define TCS_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_TCS, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define TCS_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_TCS, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define TCS_TRACE_API0(m)                                                      \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_TCS, TRACE_TYPE_API, m);                    \
    }
#define TCS_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_TCS, TRACE_TYPE_API, m, p1);                \
    }
#define TCS_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_TCS, TRACE_TYPE_API, m, p1, p2);            \
    }
#define TCS_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_TCS, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define TCS_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_TCS, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define TCS_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_TCS, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define TCS_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (tcs_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_TCS, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define ICP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_ICP, TRACE_TYPE_ERROR, m);                  \
    }
#define ICP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_ICP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define ICP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_ICP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define ICP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_ICP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define ICP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_ICP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define ICP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_ICP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define ICP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_ICP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define ICP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_ICP, TRACE_TYPE_WARNING, m);                \
    }
#define ICP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_ICP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define ICP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_ICP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define ICP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_ICP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define ICP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_ICP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define ICP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_ICP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define ICP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_ICP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define ICP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_ICP, TRACE_TYPE_EVENT, m);                  \
    }
#define ICP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_ICP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define ICP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_ICP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define ICP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_ICP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define ICP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_ICP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define ICP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_ICP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define ICP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_ICP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define ICP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_ICP, TRACE_TYPE_DEBUG, m);                  \
    }
#define ICP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_ICP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define ICP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_ICP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define ICP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_ICP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define ICP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_ICP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define ICP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_ICP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define ICP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_ICP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define ICP_TRACE_API0(m)                                                      \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_ICP, TRACE_TYPE_API, m);                    \
    }
#define ICP_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_ICP, TRACE_TYPE_API, m, p1);                \
    }
#define ICP_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_ICP, TRACE_TYPE_API, m, p1, p2);            \
    }
#define ICP_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_ICP, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define ICP_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_ICP, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define ICP_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_ICP, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define ICP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (icp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_ICP, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define CTP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_CTP, TRACE_TYPE_ERROR, m);                  \
    }
#define CTP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_CTP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define CTP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_CTP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define CTP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_CTP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define CTP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_CTP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define CTP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_CTP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define CTP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_CTP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define CTP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_CTP, TRACE_TYPE_WARNING, m);                \
    }
#define CTP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_CTP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define CTP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_CTP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define CTP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_CTP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define CTP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_CTP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define CTP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_CTP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define CTP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_CTP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define CTP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_CTP, TRACE_TYPE_EVENT, m);                  \
    }
#define CTP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_CTP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define CTP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_CTP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define CTP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_CTP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define CTP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_CTP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define CTP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_CTP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define CTP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_CTP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define CTP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_CTP, TRACE_TYPE_DEBUG, m);                  \
    }
#define CTP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_CTP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define CTP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_CTP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define CTP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_CTP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define CTP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_CTP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define CTP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_CTP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define CTP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (ctp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_CTP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define HIDH_TRACE_ERROR0(m)                                                   \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                         \
            BT_TRACE_0(TRACE_LAYER_HID, TRACE_TYPE_ERROR, m);                  \
    }
...
#define HIDH_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                         \
            BT_TRACE_5(TRACE_LAYER_HID, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define HIDH_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                         \
            BT_TRACE_6(TRACE_LAYER_HID, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define HIDH_TRACE_WARNING0(m)                                                 \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                       \
            BT_TRACE_0(TRACE_LAYER_HID, TRACE_TYPE_WARNING, m);                \
    }
...
#define HIDH_TRACE_WARNING4(m, p1, p2, p3, p4)                                 \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                       \
            BT_TRACE_4(TRACE_LAYER_HID, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define HIDH_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                             \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                       \
            BT_TRACE_5(TRACE_LAYER_HID, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define HIDH_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                         \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                       \
            BT_TRACE_6(TRACE_LAYER_HID, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define HIDH_TRACE_API0(m)                                                     \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_API)                           \
            BT_TRACE_0(TRACE_LAYER_HID, TRACE_TYPE_API, m);                    \
    }
#define HIDH_TRACE_API1(m, p1)                                                 \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_API)                           \
            BT_TRACE_1(TRACE_LAYER_HID, TRACE_TYPE_API, m, p1);                \
    }
#define HIDH_TRACE_API2(m, p1, p2)                                             \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_API)                           \
            BT_TRACE_2(TRACE_LAYER_HID, TRACE_TYPE_API, m, p1, p2);            \
    }
#define HIDH_TRACE_API3(m, p1, p2, p3)                                         \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_API)                           \
            BT_TRACE_3(TRACE_LAYER_HID, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define HIDH_TRACE_API4(m, p1, p2, p3, p4)                                     \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_API)                           \
            BT_TRACE_4(TRACE_LAYER_HID, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define HIDH_TRACE_API5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_API)                           \
            BT_TRACE_5(TRACE_LAYER_HID, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define HIDH_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_API)                           \
            BT_TRACE_6(TRACE_LAYER_HID, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define HIDH_TRACE_EVENT0(m)                                                   \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_0(TRACE_LAYER_HID, TRACE_TYPE_EVENT, m);                  \
    }
#define HIDH_TRACE_EVENT1(m, p1)                                               \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_1(TRACE_LAYER_HID, TRACE_TYPE_EVENT, m, p1);              \
    }
#define HIDH_TRACE_EVENT2(m, p1, p2)                                           \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_2(TRACE_LAYER_HID, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define HIDH_TRACE_EVENT3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_3(TRACE_LAYER_HID, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define HIDH_TRACE_EVENT4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_4(TRACE_LAYER_HID, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define HIDH_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_5(TRACE_LAYER_HID, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define HIDH_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_6(TRACE_LAYER_HID, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define HIDH_TRACE_DEBUG0(m)                                                   \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                         \
            BT_TRACE_0(TRACE_LAYER_HID, TRACE_TYPE_DEBUG, m);                  \
    }
...
#define HIDH_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                         \
            BT_TRACE_5(TRACE_LAYER_HID, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define HIDH_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (hh_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                         \
            BT_TRACE_6(TRACE_LAYER_HID, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define HSP2_TRACE_ERROR0(pcb, m)                                              \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_ERROR)                          \
            BT_TRACE_0(TRACE_LAYER_HSP2, TRACE_TYPE_ERROR, m);                 \
    }
#define HSP2_TRACE_ERROR1(pcb, m, p1)                                          \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_ERROR)                          \
            BT_TRACE_1(TRACE_LAYER_HSP2, TRACE_TYPE_ERROR, m, p1);             \
    }
#define HSP2_TRACE_ERROR2(pcb, m, p1, p2)                                      \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_ERROR)                          \
            BT_TRACE_2(TRACE_LAYER_HSP2, TRACE_TYPE_ERROR, m, p1, p2);         \
    }
#define HSP2_TRACE_ERROR3(pcb, m, p1, p2, p3)                                  \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_ERROR)                          \
            BT_TRACE_3(TRACE_LAYER_HSP2, TRACE_TYPE_ERROR, m, p1, p2, p3);     \
    }
#define HSP2_TRACE_ERROR4(pcb, m, p1, p2, p3, p4)                              \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_ERROR)                          \
            BT_TRACE_4(TRACE_LAYER_HSP2, TRACE_TYPE_ERROR, m, p1, p2, p3, p4); \
    }
#define HSP2_TRACE_ERROR5(pcb, m, p1, p2, p3, p4, p5)                          \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_ERROR)                          \
            BT_TRACE_5(TRACE_LAYER_HSP2, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define HSP2_TRACE_ERROR6(pcb, m, p1, p2, p3, p4, p5, p6)                      \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_ERROR)                          \
            BT_TRACE_6(TRACE_LAYER_HSP2, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define HSP2_TRACE_WARNING0(pcb, m)                                            \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_WARNING)                        \
            BT_TRACE_0(TRACE_LAYER_HSP2, TRACE_TYPE_WARNING, m);               \
    }
#define HSP2_TRACE_WARNING1(pcb, m, p1)                                        \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_WARNING)                        \
            BT_TRACE_1(TRACE_LAYER_HSP2, TRACE_TYPE_WARNING, m, p1);           \
    }
#define HSP2_TRACE_WARNING2(pcb, m, p1, p2)                                    \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_WARNING)                        \
            BT_TRACE_2(TRACE_LAYER_HSP2, TRACE_TYPE_WARNING, m, p1, p2);       \
    }
#define HSP2_TRACE_WARNING3(pcb, m, p1, p2, p3)                                \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_WARNING)                        \
            BT_TRACE_3(TRACE_LAYER_HSP2, TRACE_TYPE_WARNING, m, p1, p2, p3);   \
    }
#define HSP2_TRACE_WARNING4(pcb, m, p1, p2, p3, p4)                            \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_WARNING)                        \
            BT_TRACE_4(TRACE_LAYER_HSP2, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4);                                                    \
    }
#define HSP2_TRACE_WARNING5(pcb, m, p1, p2, p3, p4, p5)                        \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_WARNING)                        \
            BT_TRACE_5(TRACE_LAYER_HSP2, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5);                                                \
    }
#define HSP2_TRACE_WARNING6(pcb, m, p1, p2, p3, p4, p5, p6)                    \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_WARNING)                        \
            BT_TRACE_6(TRACE_LAYER_HSP2, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5, p6);                                            \
    }

#define HSP2_TRACE_API0(pcb, m)                                                \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_API)                            \
            BT_TRACE_0(TRACE_LAYER_HSP2, TRACE_TYPE_API, m);                   \
    }
#define HSP2_TRACE_API1(pcb, m, p1)                                            \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_API)                            \
            BT_TRACE_1(TRACE_LAYER_HSP2, TRACE_TYPE_API, m, p1);               \
    }
#define HSP2_TRACE_API2(pcb, m, p1, p2)                                        \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_API)                            \
            BT_TRACE_2(TRACE_LAYER_HSP2, TRACE_TYPE_API, m, p1, p2);           \
    }
#define HSP2_TRACE_API3(pcb, m, p1, p2, p3)                                    \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_API)                            \
            BT_TRACE_3(TRACE_LAYER_HSP2, TRACE_TYPE_API, m, p1, p2, p3);       \
    }
#define HSP2_TRACE_API4(pcb, m, p1, p2, p3, p4)                                \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_API)                            \
            BT_TRACE_4(TRACE_LAYER_HSP2, TRACE_TYPE_API, m, p1, p2, p3, p4);   \
    }
#define HSP2_TRACE_API5(pcb, m, p1, p2, p3, p4, p5)                            \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_API)                            \
            BT_TRACE_5(TRACE_LAYER_HSP2, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define HSP2_TRACE_API6(pcb, m, p1, p2, p3, p4, p5, p6)                        \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_API)                            \
            BT_TRACE_6(TRACE_LAYER_HSP2, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }

#define HSP2_TRACE_EVENT0(pcb, m)                                              \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_EVENT)                          \
            BT_TRACE_0(TRACE_LAYER_HSP2, TRACE_TYPE_EVENT, m);                 \
    }
#define HSP2_TRACE_EVENT1(pcb, m, p1)                                          \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_EVENT)                          \
            BT_TRACE_1(TRACE_LAYER_HSP2, TRACE_TYPE_EVENT, m, p1);             \
    }
#define HSP2_TRACE_EVENT2(pcb, m, p1, p2)                                      \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_EVENT)                          \
            BT_TRACE_2(TRACE_LAYER_HSP2, TRACE_TYPE_EVENT, m, p1, p2);         \
    }
#define HSP2_TRACE_EVENT3(pcb, m, p1, p2, p3)                                  \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_EVENT)                          \
            BT_TRACE_3(TRACE_LAYER_HSP2, TRACE_TYPE_EVENT, m, p1, p2, p3);     \
    }
#define HSP2_TRACE_EVENT4(pcb, m, p1, p2, p3, p4)                              \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_EVENT)                          \
            BT_TRACE_4(TRACE_LAYER_HSP2, TRACE_TYPE_EVENT, m, p1, p2, p3, p4); \
    }
#define HSP2_TRACE_EVENT5(pcb, m, p1, p2, p3, p4, p5)                          \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_EVENT)                          \
            BT_TRACE_5(TRACE_LAYER_HSP2, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define HSP2_TRACE_EVENT6(pcb, m, p1, p2, p3, p4, p5, p6)                      \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_EVENT)                          \
            BT_TRACE_6(TRACE_LAYER_HSP2, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define HSP2_TRACE_DEBUG0(pcb, m)                                              \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_DEBUG)                          \
            BT_TRACE_0(TRACE_LAYER_HSP2, TRACE_TYPE_DEBUG, m);                 \
    }
#define HSP2_TRACE_DEBUG1(pcb, m, p1)                                          \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_DEBUG)                          \
            BT_TRACE_1(TRACE_LAYER_HSP2, TRACE_TYPE_DEBUG, m, p1);             \
    }
#define HSP2_TRACE_DEBUG2(pcb, m, p1, p2)                                      \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_DEBUG)                          \
            BT_TRACE_2(TRACE_LAYER_HSP2, TRACE_TYPE_DEBUG, m, p1, p2);         \
    }
#define HSP2_TRACE_DEBUG3(pcb, m, p1, p2, p3)                                  \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_DEBUG)                          \
            BT_TRACE_3(TRACE_LAYER_HSP2, TRACE_TYPE_DEBUG, m, p1, p2, p3);     \
    }
#define HSP2_TRACE_DEBUG4(pcb, m, p1, p2, p3, p4)                              \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_DEBUG)                          \
            BT_TRACE_4(TRACE_LAYER_HSP2, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4); \
    }
#define HSP2_TRACE_DEBUG5(pcb, m, p1, p2, p3, p4, p5)                          \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_DEBUG)                          \
            BT_TRACE_5(TRACE_LAYER_HSP2, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define HSP2_TRACE_DEBUG6(pcb, m, p1, p2, p3, p4, p5, p6)                      \
    {                                                                          \
        if (pcb->trace_level >= BT_TRACE_LEVEL_DEBUG)                          \
            BT_TRACE_6(TRACE_LAYER_HSP2, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define NFC_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_NFC, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define NFC_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_NFC, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define NFC_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_NFC, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define NFC_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_NFC, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define NFC_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_NFC, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define NFC_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_NFC, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define NFC_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_NFC, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define NFC_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_NFC, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define NFC_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_NFC, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define NFC_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_NFC, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define NFC_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_NFC, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define NCI_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_NCI, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define NCI_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_NCI, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define NCI_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_NCI, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define NCI_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_NCI, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define NCI_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_NCI, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define NCI_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_NCI, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define NCI_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_NCI, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define NCI_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_NCI, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define NCI_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_NCI, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define NCI_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_NCI, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define NCI_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (nfc_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_NCI, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define RW_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (rw_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                         \
            BT_TRACE_5(TRACE_LAYER_RW, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define RW_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (rw_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                         \
            BT_TRACE_6(TRACE_LAYER_RW, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define RW_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (rw_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                       \
            BT_TRACE_5(TRACE_LAYER_RW, TRACE_TYPE_WARNING, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define RW_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (rw_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                       \
            BT_TRACE_6(TRACE_LAYER_RW, TRACE_TYPE_WARNING, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define RW_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                               \
    {                                                                          \
        if (rw_cb.trace_level >= BT_TRACE_LEVEL_API)                           \
            BT_TRACE_6(TRACE_LAYER_RW, TRACE_TYPE_API, m, p1, p2, p3, p4, p5,  \
                       p6);                                                    \
    }
...
#define RW_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (rw_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_5(TRACE_LAYER_RW, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define RW_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (rw_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_6(TRACE_LAYER_RW, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define RW_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (rw_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                         \
            BT_TRACE_5(TRACE_LAYER_RW, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define RW_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (rw_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                         \
            BT_TRACE_6(TRACE_LAYER_RW, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define CE_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (ce_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                         \
            BT_TRACE_5(TRACE_LAYER_CE, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define CE_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (ce_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                         \
            BT_TRACE_6(TRACE_LAYER_CE, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define CE_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (ce_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                       \
            BT_TRACE_5(TRACE_LAYER_CE, TRACE_TYPE_WARNING, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define CE_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (ce_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                       \
            BT_TRACE_6(TRACE_LAYER_CE, TRACE_TYPE_WARNING, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define CE_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                               \
    {                                                                          \
        if (ce_cb.trace_level >= BT_TRACE_LEVEL_API)                           \
            BT_TRACE_6(TRACE_LAYER_CE, TRACE_TYPE_API, m, p1, p2, p3, p4, p5,  \
                       p6);                                                    \
    }
...
#define CE_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (ce_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_5(TRACE_LAYER_CE, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define CE_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (ce_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                         \
            BT_TRACE_6(TRACE_LAYER_CE, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define CE_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (ce_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                         \
            BT_TRACE_5(TRACE_LAYER_CE, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define CE_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (ce_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                         \
            BT_TRACE_6(TRACE_LAYER_CE, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define NDEF_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_5(TRACE_LAYER_NDEF, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define NDEF_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_6(TRACE_LAYER_NDEF, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define NDEF_TRACE_WARNING4(m, p1, p2, p3, p4)                                 \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_4(TRACE_LAYER_NDEF, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4);                                                    \
    }
#define NDEF_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                             \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_5(TRACE_LAYER_NDEF, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5);                                                \
    }
#define NDEF_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                         \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_6(TRACE_LAYER_NDEF, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5, p6);                                            \
    }
...
#define NDEF_TRACE_API5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_5(TRACE_LAYER_NDEF, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define NDEF_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_6(TRACE_LAYER_NDEF, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define NDEF_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_5(TRACE_LAYER_NDEF, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define NDEF_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_6(TRACE_LAYER_NDEF, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define NDEF_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_5(TRACE_LAYER_NDEF, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define NDEF_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (ndef_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_6(TRACE_LAYER_NDEF, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define NFA_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                    \
            BT_TRACE_5(TRACE_LAYER_NFA, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define NFA_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                    \
            BT_TRACE_6(TRACE_LAYER_NFA, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define NFA_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                  \
            BT_TRACE_4(TRACE_LAYER_NFA, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define NFA_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                  \
            BT_TRACE_5(TRACE_LAYER_NFA, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define NFA_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                  \
            BT_TRACE_6(TRACE_LAYER_NFA, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define NFA_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_API)                      \
            BT_TRACE_5(TRACE_LAYER_NFA, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define NFA_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_API)                      \
            BT_TRACE_6(TRACE_LAYER_NFA, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define NFA_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                    \
            BT_TRACE_5(TRACE_LAYER_NFA, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define NFA_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                    \
            BT_TRACE_6(TRACE_LAYER_NFA, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define NFA_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                    \
            BT_TRACE_5(TRACE_LAYER_NFA, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define NFA_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (nfa_sys_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                    \
            BT_TRACE_6(TRACE_LAYER_NFA, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define MMI_DEBUG_2(m, p1, p2)                                                 \
    BT_TRACE_2(TRACE_LAYER_HID, TRACE_TYPE_DEBUG, m, p1, p2)
#define MMI_DEBUG_3(m, p1, p2, p3)                                             \
    BT_TRACE_3(TRACE_LAYER_HID, TRACE_TYPE_DEBUG, m, p1, p2, p3)
#define MMI_DEBUG_4(m, p1, p2, p3, p4)                                         \
    BT_TRACE_4(TRACE_LAYER_HID, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4)
#define MMI_DEBUG_5(m, p1, p2, p3, p4, p5)                                     \
    BT_TRACE_5(TRACE_LAYER_HID, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4, p5)
#define MMI_DEBUG_6(m, p1, p2, p3, p4, p5, p6)                                 \
...
#define MMI_WARNING_1(m, p1)                                                   \
    BT_TRACE_1(TRACE_LAYER_HID, TRACE_TYPE_WARNING, m, p1)
#define MMI_WARNING_2(m, p1, p2)                                               \
    BT_TRACE_2(TRACE_LAYER_HID, TRACE_TYPE_WARNING, m, p1, p2)
#define MMI_WARNING_3(m, p1, p2, p3)                                           \
    BT_TRACE_3(TRACE_LAYER_HID, TRACE_TYPE_WARNING, m, p1, p2, p3)
#define MMI_WARNING_4(m, p1, p2, p3, p4)                                       \
    BT_TRACE_4(TRACE_LAYER_HID, TRACE_TYPE_WARNING, m, p1, p2, p3, p4)
#define MMI_WARNING_5(m, p1, p2, p3, p4, p5)                                   \
    BT_TRACE_5(TRACE_LAYER_HID, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, p5)
#define MMI_WARNING_6(m, p1, p2, p3, p4, p5, p6)                               \
...
#define MMI_ERROR_2(m, p1, p2)                                                 \
    BT_TRACE_2(TRACE_LAYER_HID, TRACE_TYPE_ERROR, m, p1, p2)
#define MMI_ERROR_3(m, p1, p2, p3)                                             \
    BT_TRACE_3(TRACE_LAYER_HID, TRACE_TYPE_ERROR, m, p1, p2, p3)
#define MMI_ERROR_4(m, p1, p2, p3, p4)                                         \
    BT_TRACE_4(TRACE_LAYER_HID, TRACE_TYPE_ERROR, m, p1, p2, p3, p4)
#define MMI_ERROR_5(m, p1, p2, p3, p4, p5)                                     \
    BT_TRACE_5(TRACE_LAYER_HID, TRACE_TYPE_ERROR, m, p1, p2, p3, p4, p5)
#define MMI_ERROR_6(m, p1, p2, p3, p4, p5, p6)                                 \
...
#define DUN_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_DUN, TRACE_TYPE_ERROR, m);                  \
    }
#define DUN_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_DUN, TRACE_TYPE_ERROR, m, p1);              \
    }
#define DUN_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_DUN, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define DUN_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_DUN, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define DUN_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_DUN, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define DUN_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_DUN, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define DUN_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_DUN, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define DUN_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_DUN, TRACE_TYPE_WARNING, m);                \
    }
#define DUN_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_DUN, TRACE_TYPE_WARNING, m, p1);            \
    }
#define DUN_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_DUN, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define DUN_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_DUN, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define DUN_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_DUN, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define DUN_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_DUN, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define DUN_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_DUN, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define DUN_TRACE_API0(m)                                                      \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_DUN, TRACE_TYPE_API, m);                    \
    }
#define DUN_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_DUN, TRACE_TYPE_API, m, p1);                \
    }
#define DUN_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_DUN, TRACE_TYPE_API, m, p1, p2);            \
    }
#define DUN_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_DUN, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define DUN_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_DUN, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define DUN_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_DUN, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define DUN_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_DUN, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }

#define DUN_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_DUN, TRACE_TYPE_EVENT, m);                  \
    }
#define DUN_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_DUN, TRACE_TYPE_EVENT, m, p1);              \
    }
#define DUN_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_DUN, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define DUN_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_DUN, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define DUN_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_DUN, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define DUN_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_DUN, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define DUN_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_DUN, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define DUN_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_DUN, TRACE_TYPE_DEBUG, m);                  \
    }
#define DUN_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_DUN, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define DUN_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_DUN, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define DUN_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_DUN, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define DUN_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_DUN, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define DUN_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_DUN, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define DUN_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (dun_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_DUN, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define HCRP_TRACE_ERROR0(m)                                                   \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_0(TRACE_LAYER_HCRP, TRACE_TYPE_ERROR, m);                 \
    }
#define HCRP_TRACE_ERROR1(m, p1)                                               \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_1(TRACE_LAYER_HCRP, TRACE_TYPE_ERROR, m, p1);             \
    }
#define HCRP_TRACE_ERROR2(m, p1, p2)                                           \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_2(TRACE_LAYER_HCRP, TRACE_TYPE_ERROR, m, p1, p2);         \
    }
#define HCRP_TRACE_ERROR3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_3(TRACE_LAYER_HCRP, TRACE_TYPE_ERROR, m, p1, p2, p3);     \
    }
#define HCRP_TRACE_ERROR4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_4(TRACE_LAYER_HCRP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4); \
    }
#define HCRP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_5(TRACE_LAYER_HCRP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define HCRP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_6(TRACE_LAYER_HCRP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define HCRP_TRACE_WARNING0(m)                                                 \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_0(TRACE_LAYER_HCRP, TRACE_TYPE_WARNING, m);               \
    }
#define HCRP_TRACE_WARNING1(m, p1)                                             \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_1(TRACE_LAYER_HCRP, TRACE_TYPE_WARNING, m, p1);           \
    }
#define HCRP_TRACE_WARNING2(m, p1, p2)                                         \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_2(TRACE_LAYER_HCRP, TRACE_TYPE_WARNING, m, p1, p2);       \
    }
#define HCRP_TRACE_WARNING3(m, p1, p2, p3)                                     \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_3(TRACE_LAYER_HCRP, TRACE_TYPE_WARNING, m, p1, p2, p3);   \
    }
#define HCRP_TRACE_WARNING4(m, p1, p2, p3, p4)                                 \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_4(TRACE_LAYER_HCRP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4);                                                    \
    }
#define HCRP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                             \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_5(TRACE_LAYER_HCRP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5);                                                \
    }
#define HCRP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                         \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_6(TRACE_LAYER_HCRP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5, p6);                                            \
    }

#define HCRP_TRACE_API0(m)                                                     \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_0(TRACE_LAYER_HCRP, TRACE_TYPE_API, m);                   \
    }
#define HCRP_TRACE_API1(m, p1)                                                 \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_1(TRACE_LAYER_HCRP, TRACE_TYPE_API, m, p1);               \
    }
#define HCRP_TRACE_API2(m, p1, p2)                                             \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_2(TRACE_LAYER_HCRP, TRACE_TYPE_API, m, p1, p2);           \
    }
#define HCRP_TRACE_API3(m, p1, p2, p3)                                         \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_3(TRACE_LAYER_HCRP, TRACE_TYPE_API, m, p1, p2, p3);       \
    }
#define HCRP_TRACE_API4(m, p1, p2, p3, p4)                                     \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_4(TRACE_LAYER_HCRP, TRACE_TYPE_API, m, p1, p2, p3, p4);   \
    }
#define HCRP_TRACE_API5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_5(TRACE_LAYER_HCRP, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define HCRP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_6(TRACE_LAYER_HCRP, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }

#define HCRP_TRACE_EVENT0(m)                                                   \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_0(TRACE_LAYER_HCRP, TRACE_TYPE_EVENT, m);                 \
    }
#define HCRP_TRACE_EVENT1(m, p1)                                               \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_1(TRACE_LAYER_HCRP, TRACE_TYPE_EVENT, m, p1);             \
    }
#define HCRP_TRACE_EVENT2(m, p1, p2)                                           \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_2(TRACE_LAYER_HCRP, TRACE_TYPE_EVENT, m, p1, p2);         \
    }
#define HCRP_TRACE_EVENT3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_3(TRACE_LAYER_HCRP, TRACE_TYPE_EVENT, m, p1, p2, p3);     \
    }
#define HCRP_TRACE_EVENT4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_4(TRACE_LAYER_HCRP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4); \
    }
#define HCRP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_5(TRACE_LAYER_HCRP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define HCRP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_6(TRACE_LAYER_HCRP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define HCRP_TRACE_DEBUG0(m)                                                   \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_0(TRACE_LAYER_HCRP, TRACE_TYPE_DEBUG, m);                 \
    }
#define HCRP_TRACE_DEBUG1(m, p1)                                               \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_1(TRACE_LAYER_HCRP, TRACE_TYPE_DEBUG, m, p1);             \
    }
#define HCRP_TRACE_DEBUG2(m, p1, p2)                                           \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_2(TRACE_LAYER_HCRP, TRACE_TYPE_DEBUG, m, p1, p2);         \
    }
#define HCRP_TRACE_DEBUG3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_3(TRACE_LAYER_HCRP, TRACE_TYPE_DEBUG, m, p1, p2, p3);     \
    }
#define HCRP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_4(TRACE_LAYER_HCRP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4); \
    }
#define HCRP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_5(TRACE_LAYER_HCRP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define HCRP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (hcrp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_6(TRACE_LAYER_HCRP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define HCRPM_TRACE_ERROR0(m)                                                  \
    {                                                                          \
        if (hcrpm_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                      \
            BT_TRACE_0(TRACE_LAYER_HCRP, TRACE_TYPE_ERROR, m);                 \
    }
...
#define HCRPM_TRACE_WARNING0(m)                                                \
    {                                                                          \
        if (hcrpm_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                    \
            BT_TRACE_0(TRACE_LAYER_HCRP, TRACE_TYPE_WARNING, m);               \
    }
...
#define HCRPM_TRACE_API0(m)                                                    \
    {                                                                          \
        if (hcrpm_cb.trace_level >= BT_TRACE_LEVEL_API)                        \
            BT_TRACE_0(TRACE_LAYER_HCRP, TRACE_TYPE_API, m);                   \
    }
...
#define HCRPM_TRACE_EVENT0(m)                                                  \
    {                                                                          \
        if (hcrpm_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                      \
            BT_TRACE_0(TRACE_LAYER_HCRP, TRACE_TYPE_EVENT, m);                 \
    }
...
#define HCRPM_TRACE_DEBUG0(m)                                                  \
    {                                                                          \
        if (hcrpm_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                      \
            BT_TRACE_0(TRACE_LAYER_HCRP, TRACE_TYPE_DEBUG, m);                 \
    }
...
#define RPC_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            LogMsg_0(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_ERROR,                                     \
                     (m));                                                     \
    }
#define RPC_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            LogMsg_1(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_ERROR,                                     \
                     (m), (UINT32)(p1));                                       \
    }
#define RPC_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            LogMsg_2(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_ERROR,                                     \
                     (m), (UINT32)(p1), (UINT32)(p2));                         \
    }
#define RPC_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            LogMsg_3(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_ERROR,                                     \
                     (m), (UINT32)(p1), (UINT32)(p2), (UINT32)(p3));           \
    }
#define RPC_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            LogMsg_4(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_ERROR,                                     \
                     (m), (UINT32)(p1), (UINT32)(p2), (UINT32)(p3),            \
                     (UINT32)(p4));                                            \
    }
#define RPC_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            LogMsg_5(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_ERROR,                                     \
                     (m), (UINT32)(p1), (UINT32)(p2), (UINT32)(p3),            \
                     (UINT32)(p4), (UINT32)(p5));                              \
    }
#define RPC_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            LogMsg_6(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_ERROR,                                     \
                     (m), (UINT32)(p1), (UINT32)(p2), (UINT32)(p3),            \
                     (UINT32)(p4), (UINT32)(p5), (UINT32)(p6));                \
    }

#define RPC_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_WARNING)                         \
            LogMsg_0(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_WARNING,                                   \
                     (m));                                                     \
    }
...
#define RPC_TRACE_API0(m)                                                      \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_API)                             \
            LogMsg_0(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_API,                                       \
                     (m));                                                     \
    }
...
#define RPC_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_EVENT)                           \
            LogMsg_0(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_EVENT,                                     \
                     (m));                                                     \
    }
...
#define RPC_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (rpc_trace_level >= BT_TRACE_LEVEL_DEBUG)                           \
            LogMsg_0(TRACE_CTRL_GENERAL | TRACE_LAYER_NONE | TRACE_ORG_RPC |   \
                         TRACE_TYPE_DEBUG,                                     \
                     (m));                                                     \
    }
...
#define BNEP_TRACE_ERROR0(m)                                                   \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_0(TRACE_LAYER_BNEP, TRACE_TYPE_ERROR, m);                 \
    }
#define BNEP_TRACE_ERROR1(m, p1)                                               \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_1(TRACE_LAYER_BNEP, TRACE_TYPE_ERROR, m, p1);             \
    }
#define BNEP_TRACE_ERROR2(m, p1, p2)                                           \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_2(TRACE_LAYER_BNEP, TRACE_TYPE_ERROR, m, p1, p2);         \
    }
#define BNEP_TRACE_ERROR3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_3(TRACE_LAYER_BNEP, TRACE_TYPE_ERROR, m, p1, p2, p3);     \
    }
#define BNEP_TRACE_ERROR4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_4(TRACE_LAYER_BNEP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4); \
    }
#define BNEP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_5(TRACE_LAYER_BNEP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define BNEP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_6(TRACE_LAYER_BNEP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define BNEP_TRACE_WARNING0(m)                                                 \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_0(TRACE_LAYER_BNEP, TRACE_TYPE_WARNING, m);               \
    }
#define BNEP_TRACE_WARNING1(m, p1)                                             \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_1(TRACE_LAYER_BNEP, TRACE_TYPE_WARNING, m, p1);           \
    }
#define BNEP_TRACE_WARNING2(m, p1, p2)                                         \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_2(TRACE_LAYER_BNEP, TRACE_TYPE_WARNING, m, p1, p2);       \
    }
#define BNEP_TRACE_WARNING3(m, p1, p2, p3)                                     \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_3(TRACE_LAYER_BNEP, TRACE_TYPE_WARNING, m, p1, p2, p3);   \
    }
#define BNEP_TRACE_WARNING4(m, p1, p2, p3, p4)                                 \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_4(TRACE_LAYER_BNEP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4);                                                    \
    }
#define BNEP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                             \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_5(TRACE_LAYER_BNEP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5);                                                \
    }
#define BNEP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                         \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_6(TRACE_LAYER_BNEP, TRACE_TYPE_WARNING, m, p1, p2, p3,    \
                       p4, p5, p6);                                            \
    }
...
#define BNEP_TRACE_API0(m)                                                     \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_0(TRACE_LAYER_BNEP, TRACE_TYPE_API, m);                   \
    }
#define BNEP_TRACE_API1(m, p1)                                                 \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_1(TRACE_LAYER_BNEP, TRACE_TYPE_API, m, p1);               \
    }
#define BNEP_TRACE_API2(m, p1, p2)                                             \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_2(TRACE_LAYER_BNEP, TRACE_TYPE_API, m, p1, p2);           \
    }
#define BNEP_TRACE_API3(m, p1, p2, p3)                                         \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_3(TRACE_LAYER_BNEP, TRACE_TYPE_API, m, p1, p2, p3);       \
    }
#define BNEP_TRACE_API4(m, p1, p2, p3, p4)                                     \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_4(TRACE_LAYER_BNEP, TRACE_TYPE_API, m, p1, p2, p3, p4);   \
    }
#define BNEP_TRACE_API5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_5(TRACE_LAYER_BNEP, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define BNEP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_6(TRACE_LAYER_BNEP, TRACE_TYPE_API, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define BNEP_TRACE_EVENT0(m)                                                   \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_0(TRACE_LAYER_BNEP, TRACE_TYPE_EVENT, m);                 \
    }
#define BNEP_TRACE_EVENT1(m, p1)                                               \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_1(TRACE_LAYER_BNEP, TRACE_TYPE_EVENT, m, p1);             \
    }
#define BNEP_TRACE_EVENT2(m, p1, p2)                                           \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_2(TRACE_LAYER_BNEP, TRACE_TYPE_EVENT, m, p1, p2);         \
    }
#define BNEP_TRACE_EVENT3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_3(TRACE_LAYER_BNEP, TRACE_TYPE_EVENT, m, p1, p2, p3);     \
    }
#define BNEP_TRACE_EVENT4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_4(TRACE_LAYER_BNEP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4); \
    }
#define BNEP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_5(TRACE_LAYER_BNEP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define BNEP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_6(TRACE_LAYER_BNEP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define BNEP_TRACE_DEBUG0(m)                                                   \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_0(TRACE_LAYER_BNEP, TRACE_TYPE_DEBUG, m);                 \
    }
#define BNEP_TRACE_DEBUG1(m, p1)                                               \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_1(TRACE_LAYER_BNEP, TRACE_TYPE_DEBUG, m, p1);             \
    }
#define BNEP_TRACE_DEBUG2(m, p1, p2)                                           \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_2(TRACE_LAYER_BNEP, TRACE_TYPE_DEBUG, m, p1, p2);         \
    }
#define BNEP_TRACE_DEBUG3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_3(TRACE_LAYER_BNEP, TRACE_TYPE_DEBUG, m, p1, p2, p3);     \
    }
#define BNEP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_4(TRACE_LAYER_BNEP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4); \
    }
#define BNEP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_5(TRACE_LAYER_BNEP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define BNEP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (bnep_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_6(TRACE_LAYER_BNEP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }
...
#define PAN_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_PAN, TRACE_TYPE_ERROR, m);                  \
    }
#define PAN_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_PAN, TRACE_TYPE_ERROR, m, p1);              \
    }
#define PAN_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_PAN, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define PAN_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_PAN, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define PAN_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_PAN, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define PAN_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_PAN, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define PAN_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_PAN, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define PAN_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_PAN, TRACE_TYPE_WARNING, m);                \
    }
#define PAN_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_PAN, TRACE_TYPE_WARNING, m, p1);            \
    }
#define PAN_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_PAN, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define PAN_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_PAN, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define PAN_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_PAN, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define PAN_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_PAN, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define PAN_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_PAN, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define PAN_TRACE_API0(m)                                                      \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_PAN, TRACE_TYPE_API, m);                    \
    }
#define PAN_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_PAN, TRACE_TYPE_API, m, p1);                \
    }
#define PAN_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_PAN, TRACE_TYPE_API, m, p1, p2);            \
    }
#define PAN_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_PAN, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define PAN_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_PAN, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define PAN_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_PAN, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define PAN_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_PAN, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define PAN_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_PAN, TRACE_TYPE_EVENT, m);                  \
    }
#define PAN_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_PAN, TRACE_TYPE_EVENT, m, p1);              \
    }
#define PAN_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_PAN, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define PAN_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_PAN, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define PAN_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_PAN, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define PAN_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_PAN, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define PAN_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_PAN, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define PAN_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_PAN, TRACE_TYPE_DEBUG, m);                  \
    }
#define PAN_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_PAN, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define PAN_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_PAN, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define PAN_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_PAN, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define PAN_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_PAN, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define PAN_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_PAN, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define PAN_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (pan_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_PAN, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define SAP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_SAP, TRACE_TYPE_ERROR, m);                  \
    }
#define SAP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_SAP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define SAP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_SAP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define SAP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_SAP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define SAP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_SAP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define SAP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_SAP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SAP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_SAP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define SAP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_SAP, TRACE_TYPE_WARNING, m);                \
    }
#define SAP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_SAP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define SAP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_SAP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define SAP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_SAP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define SAP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_SAP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define SAP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_SAP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define SAP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_SAP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define SAP_TRACE_API0(m)                                                      \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_SAP, TRACE_TYPE_API, m);                    \
    }
#define SAP_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_SAP, TRACE_TYPE_API, m, p1);                \
    }
#define SAP_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_SAP, TRACE_TYPE_API, m, p1, p2);            \
    }
#define SAP_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_SAP, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define SAP_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_SAP, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define SAP_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_SAP, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define SAP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_SAP, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }

#define SAP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_SAP, TRACE_TYPE_EVENT, m);                  \
    }
#define SAP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_SAP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define SAP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_SAP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define SAP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_SAP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define SAP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_SAP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define SAP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_SAP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SAP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_SAP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define SAP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_SAP, TRACE_TYPE_DEBUG, m);                  \
    }
#define SAP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_SAP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define SAP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_SAP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define SAP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_SAP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define SAP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_SAP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define SAP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_SAP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SAP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (sap_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_SAP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define OPP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_OPP, TRACE_TYPE_ERROR, m);                  \
    }
#define OPP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_OPP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define OPP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_OPP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define OPP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_OPP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define OPP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_OPP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define OPP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_OPP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define OPP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_OPP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define OPP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_OPP, TRACE_TYPE_WARNING, m);                \
    }
#define OPP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_OPP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define OPP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_OPP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define OPP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_OPP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define OPP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_OPP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define OPP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_OPP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define OPP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_OPP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define OPP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_OPP, TRACE_TYPE_EVENT, m);                  \
    }
#define OPP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_OPP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define OPP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_OPP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define OPP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_OPP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define OPP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_OPP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define OPP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_OPP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define OPP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_OPP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define OPP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_OPP, TRACE_TYPE_DEBUG, m);                  \
    }
#define OPP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_OPP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define OPP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_OPP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define OPP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_OPP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define OPP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_OPP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define OPP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_OPP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define OPP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (opp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_OPP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define FTP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_FTP, TRACE_TYPE_ERROR, m);                  \
    }
#define FTP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_FTP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define FTP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_FTP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define FTP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_FTP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define FTP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_FTP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define FTP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_FTP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define FTP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_FTP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define FTP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_FTP, TRACE_TYPE_WARNING, m);                \
    }
#define FTP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_FTP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define FTP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_FTP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define FTP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_FTP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define FTP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_FTP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define FTP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_FTP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define FTP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_FTP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define FTP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_FTP, TRACE_TYPE_EVENT, m);                  \
    }
#define FTP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_FTP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define FTP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_FTP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define FTP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_FTP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define FTP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_FTP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define FTP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_FTP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define FTP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_FTP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define FTP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_FTP, TRACE_TYPE_DEBUG, m);                  \
    }
#define FTP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_FTP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define FTP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_FTP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define FTP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_FTP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define FTP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_FTP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define FTP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_FTP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define FTP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (ftp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_FTP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define A2D_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_A2D, TRACE_TYPE_ERROR, m);                  \
    }
#define A2D_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_A2D, TRACE_TYPE_ERROR, m, p1);              \
    }
#define A2D_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_A2D, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define A2D_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_A2D, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define A2D_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_A2D, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define A2D_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_A2D, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define A2D_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_A2D, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define A2D_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_A2D, TRACE_TYPE_WARNING, m);                \
    }
#define A2D_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_A2D, TRACE_TYPE_WARNING, m, p1);            \
    }
#define A2D_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_A2D, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define A2D_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_A2D, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define A2D_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_A2D, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define A2D_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_A2D, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define A2D_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_A2D, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define A2D_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_A2D, TRACE_TYPE_EVENT, m);                  \
    }
#define A2D_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_A2D, TRACE_TYPE_EVENT, m, p1);              \
    }
#define A2D_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_A2D, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define A2D_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_A2D, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define A2D_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_A2D, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define A2D_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_A2D, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define A2D_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_A2D, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define A2D_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_A2D, TRACE_TYPE_DEBUG, m);                  \
    }
#define A2D_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_A2D, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define A2D_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_A2D, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define A2D_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_A2D, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define A2D_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_A2D, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define A2D_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_A2D, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define A2D_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_A2D, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define A2D_TRACE_API0(m)                                                      \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_A2D, TRACE_TYPE_API, m);                    \
    }
#define A2D_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_A2D, TRACE_TYPE_API, m, p1);                \
    }
#define A2D_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_A2D, TRACE_TYPE_API, m, p1, p2);            \
    }
#define A2D_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_A2D, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define A2D_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_A2D, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define A2D_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_A2D, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define A2D_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (a2d_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_A2D, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define VDP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_AVP, TRACE_TYPE_ERROR, m);                  \
    }
#define VDP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_AVP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define VDP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_AVP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define VDP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_AVP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define VDP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_AVP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define VDP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_AVP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define VDP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_AVP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define VDP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_AVP, TRACE_TYPE_WARNING, m);                \
    }
#define VDP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_AVP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define VDP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_AVP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define VDP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_AVP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define VDP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_AVP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define VDP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_AVP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define VDP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_AVP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define VDP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_AVP, TRACE_TYPE_EVENT, m);                  \
    }
#define VDP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_AVP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define VDP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_AVP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define VDP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_AVP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define VDP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_AVP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define VDP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_AVP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define VDP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_AVP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define VDP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_AVP, TRACE_TYPE_DEBUG, m);                  \
    }
#define VDP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_AVP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define VDP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_AVP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define VDP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_AVP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define VDP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_AVP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define VDP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_AVP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define VDP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_AVP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define VDP_TRACE_API0(m)                                                      \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_AVP, TRACE_TYPE_API, m);                    \
    }
#define VDP_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_AVP, TRACE_TYPE_API, m, p1);                \
    }
#define VDP_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_AVP, TRACE_TYPE_API, m, p1, p2);            \
    }
#define VDP_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_AVP, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define VDP_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_AVP, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define VDP_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_AVP, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define VDP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (vdp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_AVP, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define LMP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            BT_TRACE_0(TRACE_LAYER_LM, TRACE_TYPE_ERROR, m);                   \
    }
#define LMP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            BT_TRACE_1(TRACE_LAYER_LM, TRACE_TYPE_ERROR, m, p1);               \
    }
#define LMP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            BT_TRACE_2(TRACE_LAYER_LM, TRACE_TYPE_ERROR, m, p1, p2);           \
    }
#define LMP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            BT_TRACE_3(TRACE_LAYER_LM, TRACE_TYPE_ERROR, m, p1, p2, p3);       \
    }
#define LMP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            BT_TRACE_4(TRACE_LAYER_LM, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);   \
    }
#define LMP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            BT_TRACE_5(TRACE_LAYER_LM, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define LMP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_ERROR)                           \
            BT_TRACE_6(TRACE_LAYER_LM, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }

#define LMP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_WARNING)                         \
            BT_TRACE_0(TRACE_LAYER_LM, TRACE_TYPE_WARNING, m);                 \
    }
#define LMP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_WARNING)                         \
            BT_TRACE_1(TRACE_LAYER_LM, TRACE_TYPE_WARNING, m, p1);             \
    }
#define LMP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_WARNING)                         \
            BT_TRACE_2(TRACE_LAYER_LM, TRACE_TYPE_WARNING, m, p1, p2);         \
    }
#define LMP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_WARNING)                         \
            BT_TRACE_3(TRACE_LAYER_LM, TRACE_TYPE_WARNING, m, p1, p2, p3);     \
    }
#define LMP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_WARNING)                         \
            BT_TRACE_4(TRACE_LAYER_LM, TRACE_TYPE_WARNING, m, p1, p2, p3, p4); \
    }
#define LMP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_WARNING)                         \
            BT_TRACE_5(TRACE_LAYER_LM, TRACE_TYPE_WARNING, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define LMP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_WARNING)                         \
            BT_TRACE_6(TRACE_LAYER_LM, TRACE_TYPE_WARNING, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define LMP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_EVENT)                           \
            BT_TRACE_0(TRACE_LAYER_LM, TRACE_TYPE_EVENT, m);                   \
    }
#define LMP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_EVENT)                           \
            BT_TRACE_1(TRACE_LAYER_LM, TRACE_TYPE_EVENT, m, p1);               \
    }
#define LMP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_EVENT)                           \
            BT_TRACE_2(TRACE_LAYER_LM, TRACE_TYPE_EVENT, m, p1, p2);           \
    }
#define LMP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_EVENT)                           \
            BT_TRACE_3(TRACE_LAYER_LM, TRACE_TYPE_EVENT, m, p1, p2, p3);       \
    }
#define LMP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_EVENT)                           \
            BT_TRACE_4(TRACE_LAYER_LM, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);   \
    }
#define LMP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_EVENT)                           \
            BT_TRACE_5(TRACE_LAYER_LM, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define LMP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_EVENT)                           \
            BT_TRACE_6(TRACE_LAYER_LM, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }

#define LMP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_DEBUG)                           \
            BT_TRACE_0(TRACE_LAYER_LM, TRACE_TYPE_DEBUG, m);                   \
    }
#define LMP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_DEBUG)                           \
            BT_TRACE_1(TRACE_LAYER_LM, TRACE_TYPE_DEBUG, m, p1);               \
    }
#define LMP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_DEBUG)                           \
            BT_TRACE_2(TRACE_LAYER_LM, TRACE_TYPE_DEBUG, m, p1, p2);           \
    }
#define LMP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_DEBUG)                           \
            BT_TRACE_3(TRACE_LAYER_LM, TRACE_TYPE_DEBUG, m, p1, p2, p3);       \
    }
#define LMP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_DEBUG)                           \
            BT_TRACE_4(TRACE_LAYER_LM, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);   \
    }
#define LMP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_DEBUG)                           \
            BT_TRACE_5(TRACE_LAYER_LM, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define LMP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (lmp_trace_level >= BT_TRACE_LEVEL_DEBUG)                           \
            BT_TRACE_6(TRACE_LAYER_LM, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define LC_TRACE_ERROR0(m)                                                     \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_ERROR])                  \
            BT_TRACE_0(TRACE_LAYER_LC, TRACE_TYPE_ERROR, m);                   \
    }
#define LC_TRACE_ERROR1(m, p1)                                                 \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_ERROR])                  \
            BT_TRACE_1(TRACE_LAYER_LC, TRACE_TYPE_ERROR, m, p1);               \
    }
#define LC_TRACE_ERROR2(m, p1, p2)                                             \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_ERROR])                  \
            BT_TRACE_2(TRACE_LAYER_LC, TRACE_TYPE_ERROR, m, p1, p2);           \
    }
#define LC_TRACE_ERROR3(m, p1, p2, p3)                                         \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_ERROR])                  \
            BT_TRACE_3(TRACE_LAYER_LC, TRACE_TYPE_ERROR, m, p1, p2, p3);       \
    }
#define LC_TRACE_ERROR4(m, p1, p2, p3, p4)                                     \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_ERROR])                  \
            BT_TRACE_4(TRACE_LAYER_LC, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);   \
    }
#define LC_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_ERROR])                  \
            BT_TRACE_5(TRACE_LAYER_LC, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define LC_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_ERROR])                  \
            BT_TRACE_6(TRACE_LAYER_LC, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }

#define LC_TRACE_WARNING0(m)                                                   \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_WARNING])                \
            BT_TRACE_0(TRACE_LAYER_LC, TRACE_TYPE_WARNING, m);                 \
    }
#define LC_TRACE_WARNING1(m, p1)                                               \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_WARNING])                \
            BT_TRACE_1(TRACE_LAYER_LC, TRACE_TYPE_WARNING, m, p1);             \
    }
#define LC_TRACE_WARNING2(m, p1, p2)                                           \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_WARNING])                \
            BT_TRACE_2(TRACE_LAYER_LC, TRACE_TYPE_WARNING, m, p1, p2);         \
    }
#define LC_TRACE_WARNING3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_WARNING])                \
            BT_TRACE_3(TRACE_LAYER_LC, TRACE_TYPE_WARNING, m, p1, p2, p3);     \
    }
#define LC_TRACE_WARNING4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_WARNING])                \
            BT_TRACE_4(TRACE_LAYER_LC, TRACE_TYPE_WARNING, m, p1, p2, p3, p4); \
    }
#define LC_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_WARNING])                \
            BT_TRACE_5(TRACE_LAYER_LC, TRACE_TYPE_WARNING, m, p1, p2, p3, p4,  \
                       p5);                                                    \
    }
#define LC_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_WARNING])                \
            BT_TRACE_6(TRACE_LAYER_LC, TRACE_TYPE_WARNING, m, p1, p2, p3, p4,  \
                       p5, p6);                                                \
    }

#define LC_TRACE_EVENT0(m)                                                     \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_EVENT])                  \
            BT_TRACE_0(TRACE_LAYER_LC, TRACE_TYPE_EVENT, m);                   \
    }
#define LC_TRACE_EVENT1(m, p1)                                                 \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_EVENT])                  \
            BT_TRACE_1(TRACE_LAYER_LC, TRACE_TYPE_EVENT, m, p1);               \
    }
#define LC_TRACE_EVENT2(m, p1, p2)                                             \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_EVENT])                  \
            BT_TRACE_2(TRACE_LAYER_LC, TRACE_TYPE_EVENT, m, p1, p2);           \
    }
#define LC_TRACE_EVENT3(m, p1, p2, p3)                                         \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_EVENT])                  \
            BT_TRACE_3(TRACE_LAYER_LC, TRACE_TYPE_EVENT, m, p1, p2, p3);       \
    }
#define LC_TRACE_EVENT4(m, p1, p2, p3, p4)                                     \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_EVENT])                  \
            BT_TRACE_4(TRACE_LAYER_LC, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);   \
    }
#define LC_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_EVENT])                  \
            BT_TRACE_5(TRACE_LAYER_LC, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define LC_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_EVENT])                  \
            BT_TRACE_6(TRACE_LAYER_LC, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }

#define LC_TRACE_DEBUG0(m)                                                     \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_DEBUG])                  \
            BT_TRACE_0(TRACE_LAYER_LC, TRACE_TYPE_DEBUG, m);                   \
    }
#define LC_TRACE_DEBUG1(m, p1)                                                 \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_DEBUG])                  \
            BT_TRACE_1(TRACE_LAYER_LC, TRACE_TYPE_DEBUG, m, p1);               \
    }
#define LC_TRACE_DEBUG2(m, p1, p2)                                             \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_DEBUG])                  \
            BT_TRACE_2(TRACE_LAYER_LC, TRACE_TYPE_DEBUG, m, p1, p2);           \
    }
#define LC_TRACE_DEBUG3(m, p1, p2, p3)                                         \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_DEBUG])                  \
            BT_TRACE_3(TRACE_LAYER_LC, TRACE_TYPE_DEBUG, m, p1, p2, p3);       \
    }
#define LC_TRACE_DEBUG4(m, p1, p2, p3, p4)                                     \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_DEBUG])                  \
            BT_TRACE_5(TRACE_LAYER_LC, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,    \
                       p5);                                                    \
    }
#define LC_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (lc_trace_level & trace_map[BT_TRACE_LEVEL_DEBUG])                  \
            BT_TRACE_6(TRACE_LAYER_LC, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,    \
                       p5, p6);                                                \
    }
...
#define SDA_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (sda_config_cb.sda_trace_level >= BT_TRACE_LEVEL_ERROR)             \
            BT_TRACE_0(m);                                                     \
    }
...
#define SDA_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (sda_config_cb.sda_trace_level >= BT_TRACE_LEVEL_ERROR)             \
            BT_TRACE_3(m, p1, p2, p3);                                         \
    }
#define SDA_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (sda_config_cb.sda_trace_level >= BT_TRACE_LEVEL_ERROR)             \
            BT_TRACE_4(m, p1, p2, p3, p4);                                     \
    }
#define SDA_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (sda_config_cb.sda_trace_level >= BT_TRACE_LEVEL_ERROR)             \
            BT_TRACE_5(m, p1, p2, p3, p4, p5);                                 \
    }
#define SDA_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (sda_config_cb.sda_trace_level >= BT_TRACE_LEVEL_ERROR)             \
            BT_TRACE_6(m, p1, p2, p3, p4, p5, p6);                             \
    }

#define SDA_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (sda_config_cb.sda_trace_level >= BT_TRACE_LEVEL_WARNING)           \
            BT_TRACE_0(m);                                                     \
    }
...
#define SDA_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (sda_config_cb.sda_trace_level >= BT_TRACE_LEVEL_EVENT)             \
            BT_TRACE_0(m);                                                     \
    }
...
#define SDA_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (sda_config_cb.sda_trace_level >= BT_TRACE_LEVEL_DEBUG)             \
            BT_TRACE_0(m);                                                     \
    }
...
#define MCA_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_MCA, TRACE_TYPE_ERROR, m);                  \
    }
#define MCA_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_MCA, TRACE_TYPE_ERROR, m, p1);              \
    }
#define MCA_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_MCA, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define MCA_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_MCA, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define MCA_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_MCA, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define MCA_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_MCA, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define MCA_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_MCA, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define MCA_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_MCA, TRACE_TYPE_WARNING, m);                \
    }
#define MCA_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_MCA, TRACE_TYPE_WARNING, m, p1);            \
    }
#define MCA_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_MCA, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define MCA_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_MCA, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define MCA_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_MCA, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define MCA_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_MCA, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define MCA_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_MCA, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define MCA_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_MCA, TRACE_TYPE_EVENT, m);                  \
    }
#define MCA_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_MCA, TRACE_TYPE_EVENT, m, p1);              \
    }
#define MCA_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_MCA, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define MCA_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_MCA, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define MCA_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_MCA, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define MCA_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_MCA, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define MCA_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_MCA, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define MCA_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_MCA, TRACE_TYPE_DEBUG, m);                  \
    }
#define MCA_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_MCA, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define MCA_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_MCA, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define MCA_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_MCA, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define MCA_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_MCA, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define MCA_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_MCA, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define MCA_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_MCA, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define MCA_TRACE_API0(m)                                                      \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_MCA, TRACE_TYPE_API, m);                    \
    }
#define MCA_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_MCA, TRACE_TYPE_API, m, p1);                \
    }
#define MCA_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_MCA, TRACE_TYPE_API, m, p1, p2);            \
    }
#define MCA_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_MCA, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define MCA_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_MCA, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define MCA_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_MCA, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define MCA_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (mca_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_MCA, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define AMP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_AMP, TRACE_TYPE_ERROR, m);                  \
    }
#define AMP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_AMP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define AMP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_AMP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define AMP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_AMP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define AMP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_AMP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define AMP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_AMP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define AMP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_AMP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define AMP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_AMP, TRACE_TYPE_WARNING, m);                \
    }
#define AMP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_AMP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define AMP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_AMP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define AMP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_AMP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define AMP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_AMP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define AMP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_AMP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define AMP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_AMP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }

#define AMP_TRACE_API0(m)                                                      \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_AMP, TRACE_TYPE_API, m);                    \
    }
#define AMP_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_AMP, TRACE_TYPE_API, m, p1);                \
    }
#define AMP_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_AMP, TRACE_TYPE_API, m, p1, p2);            \
    }
#define AMP_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_AMP, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define AMP_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_AMP, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define AMP_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_AMP, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define AMP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_AMP, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }

#define AMP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_AMP, TRACE_TYPE_EVENT, m);                  \
    }
#define AMP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_AMP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define AMP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_AMP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define AMP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_AMP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define AMP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_AMP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define AMP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_AMP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define AMP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_AMP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }

#define AMP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_AMP, TRACE_TYPE_DEBUG, m);                  \
    }
#define AMP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_AMP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define AMP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_AMP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define AMP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_AMP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define AMP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_AMP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define AMP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_AMP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define AMP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (amp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_AMP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define GATT_TRACE_ERROR0(m)                                                   \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_0(TRACE_LAYER_ATT, TRACE_TYPE_ERROR, m);                  \
    }
#define GATT_TRACE_ERROR1(m, p1)                                               \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_1(TRACE_LAYER_ATT, TRACE_TYPE_ERROR, m, p1);              \
    }
#define GATT_TRACE_ERROR2(m, p1, p2)                                           \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_2(TRACE_LAYER_ATT, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define GATT_TRACE_ERROR3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_3(TRACE_LAYER_ATT, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define GATT_TRACE_ERROR4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_4(TRACE_LAYER_ATT, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define GATT_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_5(TRACE_LAYER_ATT, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define GATT_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                       \
            BT_TRACE_6(TRACE_LAYER_ATT, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define GATT_TRACE_WARNING0(m)                                                 \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_0(TRACE_LAYER_ATT, TRACE_TYPE_WARNING, m);                \
    }
#define GATT_TRACE_WARNING1(m, p1)                                             \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_1(TRACE_LAYER_ATT, TRACE_TYPE_WARNING, m, p1);            \
    }
#define GATT_TRACE_WARNING2(m, p1, p2)                                         \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_2(TRACE_LAYER_ATT, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define GATT_TRACE_WARNING3(m, p1, p2, p3)                                     \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_3(TRACE_LAYER_ATT, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define GATT_TRACE_WARNING4(m, p1, p2, p3, p4)                                 \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_4(TRACE_LAYER_ATT, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define GATT_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                             \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_5(TRACE_LAYER_ATT, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define GATT_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                         \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                     \
            BT_TRACE_6(TRACE_LAYER_ATT, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define GATT_TRACE_API0(m)                                                     \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_0(TRACE_LAYER_ATT, TRACE_TYPE_API, m);                    \
    }
#define GATT_TRACE_API1(m, p1)                                                 \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_1(TRACE_LAYER_ATT, TRACE_TYPE_API, m, p1);                \
    }
#define GATT_TRACE_API2(m, p1, p2)                                             \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_2(TRACE_LAYER_ATT, TRACE_TYPE_API, m, p1, p2);            \
    }
#define GATT_TRACE_API3(m, p1, p2, p3)                                         \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_3(TRACE_LAYER_ATT, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define GATT_TRACE_API4(m, p1, p2, p3, p4)                                     \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_4(TRACE_LAYER_ATT, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define GATT_TRACE_API5(m, p1, p2, p3, p4, p5)                                 \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_5(TRACE_LAYER_ATT, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define GATT_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                             \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_API)                         \
            BT_TRACE_6(TRACE_LAYER_ATT, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define GATT_TRACE_EVENT0(m)                                                   \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_0(TRACE_LAYER_ATT, TRACE_TYPE_EVENT, m);                  \
    }
#define GATT_TRACE_EVENT1(m, p1)                                               \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_1(TRACE_LAYER_ATT, TRACE_TYPE_EVENT, m, p1);              \
    }
#define GATT_TRACE_EVENT2(m, p1, p2)                                           \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_2(TRACE_LAYER_ATT, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define GATT_TRACE_EVENT3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_3(TRACE_LAYER_ATT, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define GATT_TRACE_EVENT4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_4(TRACE_LAYER_ATT, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define GATT_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_5(TRACE_LAYER_ATT, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define GATT_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                       \
            BT_TRACE_6(TRACE_LAYER_ATT, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define GATT_TRACE_DEBUG0(m)                                                   \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_0(TRACE_LAYER_ATT, TRACE_TYPE_DEBUG, m);                  \
    }
#define GATT_TRACE_DEBUG1(m, p1)                                               \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_1(TRACE_LAYER_ATT, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define GATT_TRACE_DEBUG2(m, p1, p2)                                           \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_2(TRACE_LAYER_ATT, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define GATT_TRACE_DEBUG3(m, p1, p2, p3)                                       \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_3(TRACE_LAYER_ATT, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define GATT_TRACE_DEBUG4(m, p1, p2, p3, p4)                                   \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_4(TRACE_LAYER_ATT, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define GATT_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                               \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_5(TRACE_LAYER_ATT, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define GATT_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                           \
    {                                                                          \
        if (gatt_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                       \
            BT_TRACE_6(TRACE_LAYER_ATT, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define SMP_TRACE_ERROR0(m)                                                    \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_0(TRACE_LAYER_SMP, TRACE_TYPE_ERROR, m);                  \
    }
#define SMP_TRACE_ERROR1(m, p1)                                                \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_1(TRACE_LAYER_SMP, TRACE_TYPE_ERROR, m, p1);              \
    }
#define SMP_TRACE_ERROR2(m, p1, p2)                                            \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_2(TRACE_LAYER_SMP, TRACE_TYPE_ERROR, m, p1, p2);          \
    }
#define SMP_TRACE_ERROR3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_3(TRACE_LAYER_SMP, TRACE_TYPE_ERROR, m, p1, p2, p3);      \
    }
#define SMP_TRACE_ERROR4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_4(TRACE_LAYER_SMP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4);  \
    }
#define SMP_TRACE_ERROR5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_5(TRACE_LAYER_SMP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SMP_TRACE_ERROR6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_ERROR)                        \
            BT_TRACE_6(TRACE_LAYER_SMP, TRACE_TYPE_ERROR, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define SMP_TRACE_WARNING0(m)                                                  \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_0(TRACE_LAYER_SMP, TRACE_TYPE_WARNING, m);                \
    }
#define SMP_TRACE_WARNING1(m, p1)                                              \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_1(TRACE_LAYER_SMP, TRACE_TYPE_WARNING, m, p1);            \
    }
#define SMP_TRACE_WARNING2(m, p1, p2)                                          \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_2(TRACE_LAYER_SMP, TRACE_TYPE_WARNING, m, p1, p2);        \
    }
#define SMP_TRACE_WARNING3(m, p1, p2, p3)                                      \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_3(TRACE_LAYER_SMP, TRACE_TYPE_WARNING, m, p1, p2, p3);    \
    }
#define SMP_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_4(TRACE_LAYER_SMP, TRACE_TYPE_WARNING, m, p1, p2, p3,     \
                       p4);                                                    \
    }
#define SMP_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_5(TRACE_LAYER_SMP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5);                                                    \
    }
#define SMP_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_WARNING)                      \
            BT_TRACE_6(TRACE_LAYER_SMP, TRACE_TYPE_WARNING, m, p1, p2, p3, p4, \
                       p5, p6);                                                \
    }
...
#define SMP_TRACE_API0(m)                                                      \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_0(TRACE_LAYER_SMP, TRACE_TYPE_API, m);                    \
    }
#define SMP_TRACE_API1(m, p1)                                                  \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_1(TRACE_LAYER_SMP, TRACE_TYPE_API, m, p1);                \
    }
#define SMP_TRACE_API2(m, p1, p2)                                              \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_2(TRACE_LAYER_SMP, TRACE_TYPE_API, m, p1, p2);            \
    }
#define SMP_TRACE_API3(m, p1, p2, p3)                                          \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_3(TRACE_LAYER_SMP, TRACE_TYPE_API, m, p1, p2, p3);        \
    }
#define SMP_TRACE_API4(m, p1, p2, p3, p4)                                      \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_4(TRACE_LAYER_SMP, TRACE_TYPE_API, m, p1, p2, p3, p4);    \
    }
#define SMP_TRACE_API5(m, p1, p2, p3, p4, p5)                                  \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_5(TRACE_LAYER_SMP, TRACE_TYPE_API, m, p1, p2, p3, p4,     \
                       p5);                                                    \
    }
#define SMP_TRACE_API6(m, p1, p2, p3, p4, p5, p6)                              \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_API)                          \
            BT_TRACE_6(TRACE_LAYER_SMP, TRACE_TYPE_API, m, p1, p2, p3, p4, p5, \
                       p6);                                                    \
    }
...
#define SMP_TRACE_EVENT0(m)                                                    \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_0(TRACE_LAYER_SMP, TRACE_TYPE_EVENT, m);                  \
    }
#define SMP_TRACE_EVENT1(m, p1)                                                \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_1(TRACE_LAYER_SMP, TRACE_TYPE_EVENT, m, p1);              \
    }
#define SMP_TRACE_EVENT2(m, p1, p2)                                            \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_2(TRACE_LAYER_SMP, TRACE_TYPE_EVENT, m, p1, p2);          \
    }
#define SMP_TRACE_EVENT3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_3(TRACE_LAYER_SMP, TRACE_TYPE_EVENT, m, p1, p2, p3);      \
    }
#define SMP_TRACE_EVENT4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_4(TRACE_LAYER_SMP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4);  \
    }
#define SMP_TRACE_EVENT5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_5(TRACE_LAYER_SMP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SMP_TRACE_EVENT6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_EVENT)                        \
            BT_TRACE_6(TRACE_LAYER_SMP, TRACE_TYPE_EVENT, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define SMP_TRACE_DEBUG0(m)                                                    \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_0(TRACE_LAYER_SMP, TRACE_TYPE_DEBUG, m);                  \
    }
#define SMP_TRACE_DEBUG1(m, p1)                                                \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_1(TRACE_LAYER_SMP, TRACE_TYPE_DEBUG, m, p1);              \
    }
#define SMP_TRACE_DEBUG2(m, p1, p2)                                            \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_2(TRACE_LAYER_SMP, TRACE_TYPE_DEBUG, m, p1, p2);          \
    }
#define SMP_TRACE_DEBUG3(m, p1, p2, p3)                                        \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_3(TRACE_LAYER_SMP, TRACE_TYPE_DEBUG, m, p1, p2, p3);      \
    }
#define SMP_TRACE_DEBUG4(m, p1, p2, p3, p4)                                    \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_4(TRACE_LAYER_SMP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4);  \
    }
#define SMP_TRACE_DEBUG5(m, p1, p2, p3, p4, p5)                                \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_5(TRACE_LAYER_SMP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5);                                                    \
    }
#define SMP_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)                            \
    {                                                                          \
        if (smp_cb.trace_level >= BT_TRACE_LEVEL_DEBUG)                        \
            BT_TRACE_6(TRACE_LAYER_SMP, TRACE_TYPE_DEBUG, m, p1, p2, p3, p4,   \
                       p5, p6);                                                \
    }
...
#define APPL_TRACE_DEBUG6(m, p1, p2, p3, p4, p5, p6)
     ...
     (!defined(HID_MSKB_INCLUDED) || (HID_MSKB_INCLUDED == FALSE)))
...
#define DRV_TRACE_WARNING4(m, p1, p2, p3, p4)                                  \
    APPL_TRACE_WARNING4(m, p1, p2, p3, p4)
#define DRV_TRACE_WARNING5(m, p1, p2, p3, p4, p5)                              \
    APPL_TRACE_WARNING5(m, p1, p2, p3, p4, p5)
#define DRV_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)                          \
    APPL_TRACE_WARNING6(m, p1, p2, p3, p4, p5, p6)
#else
/* Driver Trace macros
 */
