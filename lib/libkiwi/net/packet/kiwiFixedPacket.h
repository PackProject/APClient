#ifndef LIBKIWI_NET_FIXED_PACKET_H
#define LIBKIWI_NET_FIXED_PACKET_H
...
/**
 * @brief Network packet of a fixed size
 */
...
public:
     ...
     */
    explicit FixedPacket(const SockAddrAny* pPeerAddr = nullptr);
...
private:
    ...
    SocketBase* mpSocket;
    //! Logic state machine
    StateMachine<FixedPacket> mStateMachine;
};
