 ...
 */
static const f32 HEART_MAX_ENERGY[Cmn::ItemMgr::BIC_HEART_COUNT + 1] = {
...
void BicInitHeartNum(Sp2::Bic::Cyclist* pCyclist) {
    ...
    pCyclist->setHeartNum(Cmn::ItemMgr::GetInstance().GetBicHeartNum());
}
...
f32 BicCalcEnergy(Sp2::Bic::Cyclist* pCyclist, f32 energy) {
    ...
    f32 energyLimit =
        HEART_MAX_ENERGY[Cmn::ItemMgr::GetInstance().GetBicHeartNum()];
