 ...
 */
int JskSetTimer() {
    return Cmn::ItemMgr::GetInstance().GetJskFreeTimerNum() * 60;
}
 ...
 */
int JskSetBalloons() {
    return Cmn::ItemMgr::GetInstance().GetJskFreeTimerNum() * 12;
}
 ...
 */
bool JskSetBoost() {
    return Cmn::ItemMgr::GetInstance().IsJskBoost();
}
 ...
 */
bool JskSetBonus() {
    return Cmn::ItemMgr::GetInstance().IsJsk2xRing();
}
 ...
 */
f32 JskSetRingTimer() {
    int timerCount = Cmn::ItemMgr::GetInstance().GetJskRingTimerNum();
