...
namespace LibWorkBench.Formats.NW4R.LayoutLib.Layout.Types
{
    ...
    /// </summary>
    public sealed class TevColorInput : IUseBinary
    {
        /// <summary>
        /// Component A in the output equation
        /// </summary>
        public GXTevColorArg A { get; set; } = GXTevColorArg.GX_CC_ZERO;

        /// <summary>
        /// Component B in the output equation
        /// </summary>
        public GXTevColorArg B { get; set; } = GXTevColorArg.GX_CC_ZERO;

        /// <summary>
        /// Component C in the output equation
        /// </summary>
        public GXTevColorArg C { get; set; } = GXTevColorArg.GX_CC_ZERO;

        /// <summary>
        /// Component D in the output equation
        /// </summary>
        public GXTevColorArg D { get; set; } = GXTevColorArg.GX_CC_ZERO;
        ...
        /// <summary>
        /// Constant color available to combiner arguments (GX_CC_KONST)
        /// </summary>
        public GXTevKColorSel Constant { get; set; }
            = GXTevKColorSel.GX_TEV_KCSEL_K0;
        ...
        public void Read(ReadStream reader)
        {
            ...
            B = (GXTevColorArg)(ab >> 4 & 0b1111);
            C = (GXTevColorArg)(cd >> 0 & 0b1111);
            D = (GXTevColorArg)(cd >> 4 & 0b1111);
            ...
            Constant = (GXTevKColorSel)(cl >> 3 & 0b11111);
        }
