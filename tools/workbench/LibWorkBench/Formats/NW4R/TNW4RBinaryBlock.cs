...
{
    /// <summary>
    /// Base class for NW4R binary-view blocks
    /// </summary>
    /// <typeparam name="TParentModel">Parent model class</typeparam>
    public abstract class TNW4RBinaryBlock<TParentModel> : TBinaryBlock<TParentModel>
        where TParentModel : NW4RBinaryModel, new()
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="dataModel">Data-view model</param>
        public abstract void DoSync(NW4RDataModel dataModel);
    }
}
