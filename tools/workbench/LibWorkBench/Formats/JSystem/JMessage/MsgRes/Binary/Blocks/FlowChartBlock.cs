...
{
    /// <summary>
    /// MsgRes flowchart block
    /// </summary>
    [BinaryBlockProfile(signature: "FLW1")]
    public sealed class FlowChartBlock : TJSystemBinaryBlock<MsgResBinaryModel>
    {
        /// <summary>
        ...
        public override void DoRead(ReadStream reader)
        {
            throw new FileNotSupportedException(
                "FlowChart block is not yet supported");
        }
