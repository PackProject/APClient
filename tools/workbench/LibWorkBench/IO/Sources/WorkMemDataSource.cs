...
{
    /// <summary>
    /// Stream data source for a resizable work/scratch memory buffer
    /// </summary>
    public class WorkMemDataSource : IDataSource
    {
        /// <summary>
        ...
        /// <summary>
        /// Underlying work memory buffer
        /// </summary>
        public byte[] Buffer => BaseStream.GetBuffer();

        /// <summary>
        /// Constructor
        /// </summary>
        public WorkMemDataSource()
        {
            // Provide no buffer to create resizable stream
