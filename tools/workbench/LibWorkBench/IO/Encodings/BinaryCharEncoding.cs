...
{
    /// <summary>
    /// Binary (null-terminated) character encoding strategy
    /// </summary>
    public sealed class BinaryCharEncoding : CharEncodingImpl, ICharEncoding
    {
        /// <summary>
        ...
        public void WriteString(IDataSource source, EndianUtil.Type endian,
                                ...
                                bool exact)
        {
            WriteStringImpl(source, Encoding.ASCII, value, maxlen, terminate, exact);
        }
